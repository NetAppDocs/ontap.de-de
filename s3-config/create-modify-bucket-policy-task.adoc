...
Ab ONTAP 9.19.1 können Sie Bedingungen verwenden, um bedingte Schreibvorgänge beim Hochladen von Objekten und bedingte Löschvorgänge beim Löschen von Objekten zu erzwingen. Bedingte Schreib- und Löschvorgänge ermöglichen es, das Überschreiben oder unbeabsichtigte Löschen von Objekten zu verhindern.
