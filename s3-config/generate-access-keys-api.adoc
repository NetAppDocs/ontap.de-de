...
NOTE: Wenn LDAP deaktiviert ist, können Sie zum Generieren von Zugriffsschlüsseln verwendenlink:../smb-config/create-server-active-directory-domain-task.html["Active Directory und SMB mit domänenbasierter Authentifizierung"].
