...
. Verknüpfen Sie die Client-Konfiguration mit dem Vserver. Siehe link:../nfs-config/enable-ldap-svms-task.html["Zuordnen der LDAP-Client-Konfiguration zu SVMs"]. Weitere Informationen zum Befehl Link:https://docs.NetApp.com/US-en/ONTAP-cli//vserver-services-name-service-ldap-create.html^] finden[`vserver services name-service ldap create` Sie in der ONTAP-Befehlsreferenz.
...
----
+
Erfahren Sie mehr über den Befehl Link:https://docs.NetApp.com/US-en/ONTAP-cli/vserver-services-name-service-ns-switch-modify.html[`vserver services name-service ns-switch modify`] in der ONTAP-Befehlsreferenz.
...
----
+
Erfahren Sie mehr über den Befehl Link:https://docs.NetApp.com/US-en/ONTAP-cli/security-login-rest-role-create.html[`security login rest-role create`] in der ONTAP-Befehlsreferenz.

. Erstellen Sie eine LDAP-Benutzergruppe mit dem Befehl für die Sicherheitsanmeldung, und fügen Sie die neue benutzerdefinierte Rolle für den Zugriff auf den REST-API-Endpunkt des S3-Benutzers hinzu. Erfahren Sie mehr über den Befehl Link:https://docs.NetApp.com/US-en/ONTAP-cli//security-login-create.html[`security login create`] in der ONTAP-Befehlsreferenz.
+
[listing]
----
