...
[role="lead"]
In ONTAP ist die zugrunde liegende Architektur für einen Bucket ein link:https://docs.netapp.com/us-en/ontap/flexgroup/definition-concept.html["FlexGroup Volume"]einziger Namespace, der aus mehreren zusammengehörigen Member Volumes besteht, aber als ein einzelnes Volume gemanagt wird.
