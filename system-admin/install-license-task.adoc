...
.Schritte
Wenn Sie bereits über link:https://docs.netapp.com/us-en/ontap/system-admin/download-nlf-task.html["Heruntergeladene NetApp-Lizenzdateien"]Lizenzschlüssel oder verfügen, können Sie mit System Manager oder der ONTAP-CLI NLFs und 28-stellige Lizenzschlüssel installieren.
