...
summary: Sie können NetApp Lizenzdateien und Lizenzschlüssel mithilfe des System Manager installieren, was die empfohlene Methode zur Installation von NLFs ist, oder Sie können die ONTAP CLI verwenden, um Lizenzschlüssel zu installieren. In ONTAP 9.10.1 und höher werden Funktionen mit einer NetApp Lizenzdatei aktiviert, und in Versionen vor ONTAP 9.10.1 werden ONTAP Funktionen mit Lizenzschlüsseln aktiviert. 
---
