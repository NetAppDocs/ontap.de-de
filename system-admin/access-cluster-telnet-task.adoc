...
Das folgende Beispiel zeigt, wie der Benutzer mit dem Namen „joe“, der über einen Telnet-Zugriff verfügt, eine Telnet-Anfrage stellen kann, um auf einen Cluster zuzugreifen, dessen Cluster-Management-LIF 10.72.137.28 lautet:
