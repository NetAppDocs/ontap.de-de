...
summary: Sie können einen Knoten mithilfe eines integrierten Controllers, dem sogenannten Serviceprozessor oder Baseboard Management Controller, fernsteuern. Dieser Fernverwaltungscontroller ist in allen aktuellen Plattformmodellen enthalten. Der Controller bleibt unabhängig vom Betriebszustand des Knotens betriebsbereit. 
---
