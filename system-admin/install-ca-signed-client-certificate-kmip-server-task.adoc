...
summary: Der Zertifikatssubtyp des Key Management Interoperability Protocol, zusammen mit den Typen client und server-ca, legt fest, dass das Zertifikat zur gegenseitigen Authentifizierung des Clusters und eines externen Schlüsselmanagers, wie beispielsweise eines KMIP-Servers, verwendet wird. 
---
