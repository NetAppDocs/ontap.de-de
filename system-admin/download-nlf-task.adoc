...
NOTE: Die Lizenzen für SnapMirror Cloud und SnapMirror S3 sind nicht in ONTAP One enthalten. Sie sind Teil des ONTAP One Kompatibilitätspaket, das Sie kostenlos erhalten können, wenn Sie ONTAP One und haben https://docs.netapp.com/us-en/ontap/data-protection/install-snapmirror-cloud-license-task.html["Separat anfordern"].
