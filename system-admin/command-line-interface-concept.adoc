...
summary: Die ONTAP-Befehlszeilenschnittstelle bietet eine befehlsbasierte Ansicht der Managementoberfläche. Sie geben Befehle an der Eingabeaufforderung des Speichersystems ein, und die Befehlsergebnisse werden als Text angezeigt. 
---
