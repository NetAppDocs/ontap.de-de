...
* Ab ONTAP 9.19.1 können Administratoren den link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=security+ssh+publickey+show["security ssh publickey show -vserver  -host-key-algorithm  command"^] verwenden, um den Fingerabdruck des ONTAP-Hostschlüssels anzuzeigen. Dies ermöglicht Administratoren zu überprüfen, ob dieser Fingerabdruck mit dem in ONTAP gespeicherten übereinstimmt.
