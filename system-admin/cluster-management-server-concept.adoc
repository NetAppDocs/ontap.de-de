...
summary: Der Cluster-Management-Server, auch AdminSVM genannt, ist eine spezielle Storage Virtual Machine-Implementierung, die den Cluster als eine einzige verwaltbare Einheit darstellt. Zusätzlich dazu, dass er als oberste administrative Domäne dient, besitzt der Cluster-Management-Server Ressourcen, die logisch nicht zu einer Data-SVM gehören. 
---
