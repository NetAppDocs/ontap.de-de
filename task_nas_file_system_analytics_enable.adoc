...
| 1. Wählen Sie *Storage > Volumes*. 2. Wählen Sie das gewünschte Volume aus, und wählen Sie dann *Explorer*. 3. Wählen Sie *Enable Analytics* oder *Disable Analytics* aus. | 1. Wählen Sie *Storage > Volumes*. 2. Wählen Sie das gewünschte Volumen aus. Wählen Sie im Menü für einzelne Volumes die Option *Dateisystem > Explorer* aus. 3. Wählen Sie *Enable Analytics* oder *Disable Analytics* aus. 
|===
--
.CLI
--
