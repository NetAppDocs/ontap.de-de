...
.Was Sie benötigen
Eine FlexClone Lizenz muss installiert sein. Diese Lizenz ist im enthalten link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"].
