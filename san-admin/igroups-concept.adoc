...
summary: Initiatorgruppen sind Tabellen mit WWPNs von FC-Protokoll-Hosts oder iSCSI-Hostknotennamen. Sie können Initiatorgruppen definieren und diese LUNs zuordnen, um zu steuern, welche Initiatoren Zugriff auf LUNs haben. 
---
