...
Wenn Sie ein ASA r2 Speichersystem (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 oder ASA A20) besitzen, siehe die link:https://docs.netapp.com/us-en/asa-r2/index.html["Dokumentation zum ASA r2 Storage-System"^].
