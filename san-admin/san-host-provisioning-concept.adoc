...
summary: In SAN-Umgebungen sind Speichersysteme Ziele mit Speicherzielgeräten. Bei iSCSI und FC werden die Speicherzielgeräte als LUNs bezeichnet. Bei Non-Volatile Memory Express über Fibre Channel werden die Speicherzielgeräte als Namespaces bezeichnet. 
---
