...
* Erfahren Sie link:https://docs.netapp.com/us-en/asa-r2/manage-data/provision-san-storage.html["Bereitstellung von SAN-Storage"^]mehr zu ASA r2 (ASA A1K, ASA A70 oder ASA A90) Storage-Systemen.
