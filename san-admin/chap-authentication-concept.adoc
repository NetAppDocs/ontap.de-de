...
summary: Das Challenge Handshake Authentication Protocol ermöglicht die authentifizierte Kommunikation zwischen iSCSI-Initiatoren und -Zielen. Wenn Sie die CHAP-Authentifizierung verwenden, definieren Sie CHAP-Benutzernamen und -Passwörter sowohl auf dem Initiator als auch auf dem Speichersystem. 
---
