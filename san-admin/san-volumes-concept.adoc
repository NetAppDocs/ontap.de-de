...
summary: 'ONTAP bietet drei grundlegende Optionen für die Volume-Bereitstellung: Thick Provisioning, Thin Provisioning und Semi-Thick Provisioning. Jede Option verwendet unterschiedliche Methoden zur Verwaltung des Volume-Speicherplatzes und der Speicheranforderungen für ONTAP Block-Sharing-Technologien. Das Verständnis der Funktionsweise der Optionen ermöglicht es Ihnen, die beste Option für Ihre Umgebung auszuwählen.' 
---
