...
summary: Sie können eine LUN innerhalb einer Storage Virtual Machine zwischen verschiedenen Volumes verschieben, jedoch nicht zwischen verschiedenen SVMs. LUNs, die innerhalb einer SVM zwischen verschiedenen Volumes verschoben werden, werden sofort und ohne Verbindungsverlust verschoben. 
---
