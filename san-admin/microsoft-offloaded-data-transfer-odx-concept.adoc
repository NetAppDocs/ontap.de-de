...
Bei der Verwendung von VMware- und Microsoft-Copy-Offload in virtualisierten Umgebungen müssen Ihre LUNs aufeinander abgestimmt sein.  Nicht ausgerichtete LUNs können die Leistung beeinträchtigen. link:io-misalignments-properly-aligned-luns-concept.html["Erfahren Sie mehr über nicht ausgerichtete LUNs"].
