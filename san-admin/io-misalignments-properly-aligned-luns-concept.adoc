...
summary: ONTAP kann Fehlausrichtungen von Eingabe und Ausgabe bei korrekt ausgerichteten LUNs melden. Im Allgemeinen können diese Warnungen ignoriert werden, solange Sie sicher sind, dass Ihre LUN korrekt bereitgestellt und Ihre Partitionstabelle korrekt ist. 
---
