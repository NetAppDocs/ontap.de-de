...
summary: Mit dem Befehl „storage encryption disk modify“ kann einem FIPS-Laufwerk oder SED ein Authentifizierungsschlüssel für Daten zugewiesen werden. Clusterknoten verwenden diesen Schlüssel, um auf die Daten auf dem Laufwerk zuzugreifen. 
---
...
[NOTE]
====
Mit dem  `security key-manager key query -key-type NSE-AK` Befehl lassen sich die Schlüssel-IDs anzeigen.
