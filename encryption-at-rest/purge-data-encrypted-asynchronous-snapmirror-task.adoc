...
summary: Ab ONTAP 9.8 können Sie Secure-Purge verwenden, um Daten auf NVE-fähigen Volumes mit einer asynchronen SnapMirror Beziehung unterbrechungsfrei zu bereinigen. 
---
