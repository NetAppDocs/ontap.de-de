...
* Sie müssen die aktuelle Passphrase für die Onboard Schlüsselverwaltung eingeben, bevor Sie eine neue Passphrase festlegen können.
...
+
Nachdem Sie den Befehl eingegeben haben, antworten Sie auf die Aufforderungen, um die aktuelle Passphrase, die neue Passphrase und zur Bestätigung erneut die neue Passphrase einzugeben.
...
--
====
. Wenn Sie dazu aufgefordert werden, geben Sie die aktuelle Passphrase ein.
. Geben Sie eine neue Passphrase mit 32 bis 256 Zeichen ein oder für "`cc-mode`" eine Passphrase mit 64 bis 256 Zeichen.
+
...
. An der Aufforderung zur Bestätigung der Passphrase ist die neue Passphrase erneut einzugeben.
