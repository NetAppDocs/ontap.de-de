...
Nachdem die Passphrase des Onboard Key Managers konfiguriert wurde, sollten die Informationen manuell an einem sicheren Ort außerhalb des Speichersystems gesichert werden. Siehe link:backup-key-management-information-manual-task.html["Onboard-Schlüsselverwaltungsinformationen manuell sichern"].
