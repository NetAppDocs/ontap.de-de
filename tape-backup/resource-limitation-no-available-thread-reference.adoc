...
summary: Die maximale Anzahl aktiver lokaler Tape-Ein- und -Ausgabe-Threads ist derzeit in Gebrauch. Sie können maximal 16 aktive lokale Tape-Laufwerke haben. 
---
