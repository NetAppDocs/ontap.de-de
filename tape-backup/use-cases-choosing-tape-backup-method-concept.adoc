...
summary: 'ONTAP unterstützt zwei Backup-Engines: SMTape und dump. Sie sollten die Anwendungsfälle der SMTape- und dump-Backup-Engines kennen, um die passende Backup-Engine für Tape-Backup- und Wiederherstellungsvorgänge auszuwählen.' 
---
