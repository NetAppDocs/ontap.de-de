...
summary: Im NDMP-Modus mit Bezug zur virtuellen Speichermaschine müssen Sie ein Passwort für eine bestimmte Benutzer-ID generieren. Das generierte Passwort basiert auf dem tatsächlichen Anmeldepasswort des NDMP-Benutzers. Ändert sich das tatsächliche Anmeldepasswort, müssen Sie das NDMP-spezifische Passwort erneut generieren. 
---
