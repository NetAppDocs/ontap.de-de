...
summary: Im NDMP-Modus mit Bezug zur Storage Virtual Machine hängen die unterstützten NDMP-Datenverbindungstypen vom LIF-Typ der NDMP-Steuerverbindung und dem Status der CAB-Erweiterung ab. Dieser NDMP-Datenverbindungstyp gibt an, ob Sie eine lokale oder eine Drei-Wege-NDMP-Backup- oder Restore-Operation durchführen können. 
---
