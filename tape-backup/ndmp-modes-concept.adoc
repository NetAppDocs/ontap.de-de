...
summary: Sie können Tape-Backup- und Wiederherstellungsvorgänge entweder auf Knotenebene oder auf Ebene der Storage Virtual Machine durchführen. Um diese Vorgänge auf SVM-Ebene erfolgreich auszuführen, muss der NDMP-Service auf der SVM aktiviert sein. 
---
