...
summary: ONTAP unterstützt Tape-Backup und -Wiederherstellung über das Network Data Management Protocol. NDMP ermöglicht es Ihnen, Daten in Speichersystemen direkt auf Band zu sichern, was zu einer effizienten Nutzung der Bandbreite führt. ONTAP unterstützt sowohl Dump- als auch SMTape-Engines für Tape-Backup. 
---
