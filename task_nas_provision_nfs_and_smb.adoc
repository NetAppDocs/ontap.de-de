...
| System Manager Classic (ONTAP 9.7 und älter) | https://docs.netapp.com/us-en/ontap-sm-classic/nas-multiprotocol-config/index.html["Die Multiprotokollkonfiguration von SMB und NFS im Überblick"^] 
...
* link:nfs-config/index.html["Überblick über die NFS-Konfiguration mit der CLI"]
