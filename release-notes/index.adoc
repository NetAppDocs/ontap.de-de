...
ONTAP 9.15.1 bietet neue und erweiterte Funktionen in den Bereichen Sicherheitsmanagement, Datensicherung und Unterstützung von NAS-Workloads. Eine vollständige Liste der neuen Funktionen und Verbesserungen finden Sie unter xref:9151-reference.adoc[Was ist neu in ONTAP 9.15.1].
...
* xref:../flexcache/flexcache-writeback-enable-task.html[FlexCache-Schreibzugriff]
+
