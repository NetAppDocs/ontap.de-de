...
ONTAP 9.14.1 bietet neue und erweiterte Funktionen in den Bereichen Angebote FabricPool, Ransomware-Schutz, OAuth, mehr. Eine vollständige Liste der neuen Funktionen und Verbesserungen finden Sie unter xref:9141-reference.adoc[Was ist neu in ONTAP 9.14.1].
...
ONTAP 9.12.1 bietet neue und erweiterte Funktionen in den Bereichen Erhöhung der Sicherheit, Aufbewahrung, Performance und vieles mehr. Eine vollständige Liste der neuen Funktionen und Verbesserungen finden Sie unter xref:9121.adoc[Was ist neu in ONTAP 9.12.1].
