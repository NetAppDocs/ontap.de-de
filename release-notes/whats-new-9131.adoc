...
Ab ONTAP 9.12.1 ist System Manager in die NetApp Konsole integriert. Erfahren Sie mehr über xref:../sysmgr-integration-console-concept.html[System Manager-Integration mit der NetApp Konsole] .
