...
| xref:../file-system-analytics/activity-tracking-task.html[Verfolgung von aktiven Objekten mit File System Analytics (FSA)] | Die Aktivitätsverfolgung wird auf SVM-Ebene aggregiert und verfolgt Lese-/Schreib-IOPS und Durchsatz, um sofortige, verwertbare Erkenntnisse zu Daten zu ermöglichen. 
