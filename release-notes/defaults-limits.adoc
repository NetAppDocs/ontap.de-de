...
| Autonomer Schutz durch Ransomware (ARP) | ARP/AI ist auf unterstützten Plattformen nach einer 12-stündigen Testphase auf allen neuen Volumes standardmäßig automatisch aktiviert. | ONTAP 9.18.1 
...
| Gleichzeitige SnapMirror Übertragung | Die maximale Anzahl asynchroner, gleichzeitiger Übertragungen auf Volumenebene wurde von 100 auf 200 erhöht.  Die Anzahl der SnapMirror Cloud-Übertragungen hat sich auf High-End-Systemen von 32 auf 100 und auf Low-End-Systemen von 6 auf 20 erhöht. | ONTAP 9,8 
