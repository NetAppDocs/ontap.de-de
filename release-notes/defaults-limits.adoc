...
| Lautstärkestandards | Bei Volumes, die auf neu erstellten SVMs auf ONTAP -Clustern erstellt wurden, die für NAS-Protokolle zugewiesen sind, ist File System Analytics (FSA) standardmäßig aktiviert. | ONTAP 9.17.1 
