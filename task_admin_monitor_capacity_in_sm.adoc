...
NOTE: Messungen der genutzten Kapazität werden abhängig von der Version von System Manager, die Sie verwenden, unterschiedlich angezeigt, wie in erläutert link:./concepts/concept_capacity_measurements_in_sm.html["Kapazitätsmessungen in System Manager"].
