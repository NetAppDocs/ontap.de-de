...
.Schritt
. Verwenden Sie den `vol show` Befehl mit der `-fieldsneeds-object-retagging` Option, um zu sehen, ob das Tagging ausgeführt wird, ob es abgeschlossen ist oder ob das Tagging nicht eingestellt ist.
+
[listing]
----
