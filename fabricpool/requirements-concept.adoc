...
* Eine Cloud-Tier kann nach der Anbindung nicht von einer lokalen Tier entfernt werden, Sie können jedoch verwenden link:https:create-mirror-task.html["FabricPool Spiegel"] Um eine lokale Tier mit einer anderen Cloud-Tier zu verbinden.
