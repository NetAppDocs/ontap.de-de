...
====
+
https://["NDMP Backup und Restore Unterstützung für FabricPool"]
...
*** FAS2620
+
Prüfen https://["Hardware Universe"^] Für die neuesten unterstützten Modelle.
...
+
http://["Technischer Bericht 4598: FabricPool Best Practices in ONTAP 9"^]
