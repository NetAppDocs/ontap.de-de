...
. (Optional) Falls eine Zertifikatsvalidierung erforderlich ist und der Hostname geändert wurde, link:../s3-config/create-install-ca-certificate-svm-task.html["das Zertifikat erneuern"].
...
+
Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/ontap-cli/storage-aggregate-object-store-show.html#description["storage aggregate object-store show"^].
