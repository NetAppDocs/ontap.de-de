...
Beim sequenziellen Lesen bleiben kalte Blöcke in einem Volume mit der Tiering-Richtlinie Auto kalt und verbleiben auf der Cloud-Ebene. Sie werden nicht zurück auf die lokale Ebene geschrieben.
