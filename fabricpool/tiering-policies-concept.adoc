...
====
Sie können das verwenden `volume object-store tiering show` Befehl zum Anzeigen des Tiering-Status eines FabricPool Volumes. Weitere Informationen finden Sie im link:https://docs.netapp.com/us-en/ontap-cli/["Befehlsreferenz"].
