...
* A link:https://console.netapp.com/cloud-tiering["NetApp Cloud Tiering-Lizenz"^] ist erforderlich, wenn Sie Alibaba Cloud Object Storage als Speicherebene nutzen. Weitere Informationen finden Sie unter link:install-license-aws-azure-ibm-task.html["Installieren Sie eine FabricPool-Lizenz auf einem ONTAP-Cluster"].
