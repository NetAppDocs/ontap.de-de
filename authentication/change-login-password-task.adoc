...
NOTE: Sie können das verwenden `security login role config modify` Befehl zum Ändern der Kennwortregeln für Konten, die einer bestimmten Rolle zugeordnet sind. Weitere Informationen finden Sie im link:https://docs.netapp.com/us-en/ontap-cli-9141/security-login-role-config-modify.html["Befehlsreferenz"^].
