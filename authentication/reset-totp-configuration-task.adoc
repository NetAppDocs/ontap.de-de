...
NOTE: Ab ONTAP 9.19.1 müssen Sie zum Löschen Ihres TOTP-Geheimschlüssels über die CLI einen gültigen TOTP-Code oder Scratch-Code eingeben. Sie können Ihren TOTP-Geheimschlüssel nicht über die REST-API löschen.
