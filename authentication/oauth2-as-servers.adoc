...
Die wichtigsten Aspekte der ONTAP-Konfiguration sind im Folgenden aufgeführt. Siehe auch link:../authentication/oauth2-deployment-scenarios.html["OAuth 2.0-Bereitstellungsszenarien"] Finden Sie weitere Informationen.
...
|===
Siehe https://www.rfc-editor.org/info/rfc7519["RFC 7519: JSON Web Tokens"^] Finden Sie weitere Informationen.
