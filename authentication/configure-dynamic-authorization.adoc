...
Erfahren Sie mehr über den Befehl Link:https://docs.NetApp.com/US-en/ONTAP-cli/security-dynamic-authorization-rule-create.html[`security dynamic-authorization rule create`] in der ONTAP-Befehlsreferenz.
...
Erfahren Sie mehr über den Link:https://docs.NetApp.com/US-en/ONTAP-cli/Security-Dynamic-Authorization-user-Trust-score-Reset.HTML`[`security dynamic-authorization user-trust-score reset`^] Befehl in der ONTAP Befehlsreferenz.
