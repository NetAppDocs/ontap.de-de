...
summary: Zur Installation der Software müssen Sie die Installationsdatei der virtuellen Appliance herunterladen und dann mithilfe eines VMware vSphere Clients die Datei auf einem VMware ESXi-Server bereitstellen. Die virtuelle Appliance ist als OVA-Datei verfügbar. 
---
