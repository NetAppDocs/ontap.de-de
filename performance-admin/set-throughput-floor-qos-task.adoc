...
+ mit dem folgenden Befehl wird die Gruppe der gemeinsam genutzten Richtlinien mit einem Mindestdurchsatz von 1,000 IOPS erstellt `pg-vs2`:
...
----
+ mit dem folgenden Befehl wird die nicht freigegebene Richtliniengruppe ohne Durchsatzbegrenzung erstellt `pg-vs4`:
