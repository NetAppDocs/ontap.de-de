...
+
`_storage_object_ create -vserver _SVM_ -qos-policy-group _policy_group_`Sie können die `_storage_object_modify` Befehl, um eine andere Richtliniengruppe auf das Speicherobjekt anzuwenden.
