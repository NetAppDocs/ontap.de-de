...
Sie können mit dem `volume snaplock show` Befehl die Einstellungen für den Aufbewahrungszeitraum für das Volume anzeigen. Weitere Informationen finden Sie auf der man-Page für den Befehl.
...
====
Für erweiterte Verwendung siehe link:https://www.netapp.com/us/media/tr-4526.pdf["Worm-Speicherung gemäß NetApp SnapLock"].
