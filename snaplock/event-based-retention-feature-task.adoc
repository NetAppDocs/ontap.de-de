...
summary: 'Ab ONTAP 9.3 können Sie mit der Funktion „SnapLock Event Based Retention“ (EBR) festlegen, wie lange eine Datei nach dem Auftreten eines Ereignisses aufbewahrt wird.' 
---
= Verwenden Sie die Ereignisbasierte Aufbewahrungsfunktion (EBR)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Ab ONTAP 9.3 können Sie mit der Funktion SnapLock _ereignisbasierte Aufbewahrung (EBR)_ festlegen, wie lange eine Datei nach dem Auftreten eines Ereignisses aufbewahrt wird.
