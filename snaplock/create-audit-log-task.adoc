...
Ab ONTAP 9.10.1 erstellen Sie kein SnapLock Aggregat mehr. Sie müssen die Option -SnapLock-type für verwendenlink:https://docs.netapp.com/us-en/ontap/snaplock/create-snaplock-volume-task.html["Explizit ein SnapLock Volume erstellen"], indem Sie entweder Compliance oder Enterprise als SnapLock-Typ angeben.
