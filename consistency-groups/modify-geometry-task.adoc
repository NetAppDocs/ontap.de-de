...
* Vorhandene Ssapshot-Kopien der vor der Erweiterung erfassten Konsistenzgruppe gelten als teilweise. Bei jedem auf dieser Snapshot Kopie basierenden Wiederherstellungsvorgang wird die Konsistenzgruppe zum Zeitpunkt der Snapshot Kopie wiedergegeben.
