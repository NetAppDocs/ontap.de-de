...
Ab ONTAP 9.11.1 unterstützen Konsistenzgruppen auch link:protect-task.html#two-phase-CG-snapshot-creation["Erstellen von Snapshots von Konsistenzgruppen in zwei Phasen"].
