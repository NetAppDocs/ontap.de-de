...
[role="lead"]
Konsistenzgruppen können mit vorhandenen Volumes oder neuen Volumes erstellt werden. Sobald ein Volume einer Konsistenzgruppe hinzugefügt wurde, kann es nicht einer anderen Konsistenzgruppe hinzugefügt werden.
