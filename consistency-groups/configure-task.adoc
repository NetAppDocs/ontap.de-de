...
[role="lead"]
Konsistenzgruppen können mit vorhandenen Volumes oder mit neuen LUNs erstellt werden. Sobald ein Volume einer Konsistenzgruppe zugeordnet ist, kann es nicht einer anderen Konsistenzgruppe hinzugefügt werden.
