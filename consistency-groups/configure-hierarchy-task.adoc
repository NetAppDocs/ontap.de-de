...
+
Der `volume-count` Parameter legt die Anzahl der Volumes in jeder untergeordneten Konsistenzgruppe fest. Sie können eine übergeordnete Konsistenzgruppe mit maximal fünf untergeordneten Konsistenzgruppen erstellen.
