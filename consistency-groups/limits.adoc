...
NOTE: Wenn Sie die Business Continuity von SnapMirror nutzen, lesen Sie link:../smbc/considerations-limits.html["SM-BC Einschränkungen und Einschränkungen nach Limits"].
