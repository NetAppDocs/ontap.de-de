...
* Sie können einer Konsistenzgruppe bis zu 16 Volumes gleichzeitig hinzufügen, vorausgesetzt, dass sich Anpassungen im gesamten befinden xref:index.html#consistency-group-object-limits[Einschränkungen für Konsistenzgruppen].
