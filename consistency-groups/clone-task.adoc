...
* Wenn Sie versuchen, eine Konsistenzgruppe auf der Grundlage eines Snapshots zu klonen, der die aktuelle Konfiguration der Konsistenzgruppe nicht wiedergibt, schlägt der Vorgang fehl.
