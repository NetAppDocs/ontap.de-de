...
* Deaktivieren Sie SMB Multichannel, bevor Sie die erweiterte Kapazitätsverteilung aktivieren. Die Verwendung von SMB Multichannel mit erweiterter Kapazitätsverteilung kann zu hoher Latenz führen. Weitere Informationen finden Sie unter link:https://kb.netapp.com/on-prem/ontap/da/NAS/NAS-Issues/CONTAP-400433["CONTAP-400433: Hohe Latenz beim Lesen/Schreiben bei Verwendung von FlexGroup Rebalancing/GDD über SMB Multichannel-aktivierte Clients"^].
