...
link:aggregate-space-requirements-concept.html["Richtlinien für Aggregat-Speicherplatz bei der Bereitstellung eines FlexGroup Volume"]

Außerdem sollten Sie bei der Auswahl von Aggregaten für die Bereitstellung eines FlexGroup-Volume auf die Überlegungen und Anforderungen achten.
