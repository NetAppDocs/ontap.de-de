...
.CLI
--
. Automatische Neuverteilung starten: `volume rebalance start -vserver _SVM_name_ -volume _volume_name_`
+
...
.CLI
--
. Automatische Neuverteilung ändern: `volume rebalance modify -vserver _SVM_name_ -volume _volume_name_`
+
...
.CLI
--
. Anzeigen des Status eines FlexGroup-Ausgleichs: `volume rebalance show`
+
