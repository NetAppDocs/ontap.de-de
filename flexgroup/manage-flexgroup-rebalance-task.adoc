...
+
Das Ausbalancieren mit der störenden, retroaktiven Dateiverschiebungsfunktion kann die Performance beeinträchtigen, wenn eine große Anzahl von Dateien verschoben wird, beispielsweise bei einer Konvertierung von FlexVol zu FlexGroup und 50 bis 85 % der Daten auf dem FlexVol Volume in eine neue Komponente verschoben werden.
