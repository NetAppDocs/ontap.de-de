...
* ONTAP S3
+
FlexGroup-Rebalancing wird auf ONTAP S3 FlexGroup Volumes nicht unterstützt, bei denen keine Ungleichgewichte in der gleichen Weise wie NAS-FlexGroup-Volumes entstehen.
