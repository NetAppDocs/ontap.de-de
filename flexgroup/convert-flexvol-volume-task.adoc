...
** Der autonome Ransomware-Schutz (ARP) wurde auf dem Volume deaktiviert.  Sie sollten es erst wieder aktivieren, wenn die Konvertierung abgeschlossen ist.
