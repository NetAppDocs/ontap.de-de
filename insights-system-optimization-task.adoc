...
.Über diese Aufgabe
Dieses Verfahren gilt für FAS, AFF und aktuelle ASA Systeme. Wenn Sie über ein ASA r2-System (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 oder ASA A20) verfügen, folgen Sielink:https://docs.netapp.com/us-en/asa-r2/monitor/view-insights.html["Diesen Schritten ausführen"^], um Informationen zur Optimierung Ihres Systems anzuzeigen. ASA r2 Systeme bieten eine vereinfachte ONTAP-Erfahrung speziell für reine SAN-Kunden.
