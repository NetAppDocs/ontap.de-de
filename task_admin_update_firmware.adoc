...
Ab ONTAP 9.9 können Sie mit System Manager Firmware-Updates von der Seite *Update* herunterladen, wenn Sie Firmware-Warnungen anzeigen (siehe  firmware update alerts from Active IQ.).
...
ONTAP 9.10.1
 a| 
*Hinweis:* um Korrekturen und Aktualisierungen automatisch zu planen und Empfehlungen zur Aktualisierung zu erhalten, siehe .
