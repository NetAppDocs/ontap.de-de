...
Details zur Konfiguration von NTP in ONTAP finden Sie unter link:https:../system-admin/manage-cluster-time-concept.html["Verwalten der Cluster-Zeit (nur Cluster-Administratoren)"].
