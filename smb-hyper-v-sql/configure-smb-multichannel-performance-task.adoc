...
summary: Konfigurieren Sie SMB Multichannel für mehrere Verbindungen zwischen ONTAP und Clients in einer einzigen SMB-Sitzung, um den Durchsatz und die Fehlertoleranz für Hyper-V- und SQL-Server über SMB-Konfigurationen zu verbessern. 
---
