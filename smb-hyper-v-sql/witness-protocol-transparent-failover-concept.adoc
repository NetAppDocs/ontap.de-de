...
summary: Das Witness-Protokoll bietet verbesserte Client-Failover-Funktionen für permanent verfügbare SMB 3.0-Freigaben. Witness ermöglicht ein schnelleres Failover, da es die LIF-Failover-Wiederherstellungsphase umgeht. Es benachrichtigt Anwendungsserver, wenn ein Knoten nicht verfügbar ist, ohne auf ein Timeout der SMB 3.0-Verbindung warten zu müssen. 
---
