...
* NetApp Backup and Recovery schützt eigenständige Hyper-V-VMs, FCI-Clusterinstanzen und mit System Center Virtual Machine Manager (SCVMM) bereitgestellte virtuelle Maschinen, die auf CIFS-Freigaben gehostet werden.
+
Informationen zum Schutz von Hyper-V-Workloads mit NetApp Backup and Recovery finden sich unter  https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-hyperv-protect-overview.html["Übersicht zum Schutz von Hyper-V-Workloads"].
