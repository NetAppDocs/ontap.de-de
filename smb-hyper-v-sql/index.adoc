...
Weitere Informationen zur ONTAP-Technologie und zur Interaktion mit externen Diensten finden Sie in diesen Technical Reports (TRs): ** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["Technischer Bericht 4172 von NetApp: Microsoft Hyper-V over SMB 3.0 with ONTAP Best Practices"^]
