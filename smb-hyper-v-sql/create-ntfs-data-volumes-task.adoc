...
summary: Sie müssen NTFS-Datenvolumes auf der Storage Virtual Machine erstellen, bevor Sie permanent verfügbare Freigaben für die Verwendung mit Hyper-V- oder SQL Server-over-SMB-Anwendungsservern konfigurieren können. Verwenden Sie das Arbeitsblatt zur Volume-Konfiguration, um Ihre Datenvolumes zu erstellen. 
---
