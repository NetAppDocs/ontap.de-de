...
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/manage-groups-task.html["Erstellen einer oder mehrerer Genehmigungsgruppen für Administratoren"]
* link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/enable-disable-task.html["Aktivieren der Überprüfungsfunktion für mehrere Administratoren"]
...
. Wenn ein Benutzer den Vorgang initiiert, wird ein angezeigt link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/request-operation-task.html["Die Anforderung wird generiert."]
. Bevor es ausgeführt werden kann, muss die erforderliche Anzahl von angegeben werden link:https://docs.netapp.com/us-en/ontap/multi-admin-verify/manage-requests-task.html["MAV-Administratoren müssen genehmigen."]
