...
Weitere Informationen zu diesem Befehl finden Sie im link:http://docs.netapp.com/us-en/ontap-cli/network-connections-active-show-clients.html["ONTAP-Befehlsreferenz"^].
