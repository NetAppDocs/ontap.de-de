...
Weitere Informationen zum Befehl Link:http://docs.NetApp.com/US-en/ONTAP-cli/network-connections-active-show-clients.html^] finden[`network connections active show-clients` Sie in der ONTAP-Befehlsreferenz.
