...
---
= Informationen zur IP-Sicherheit im ONTAP Netzwerk
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Bei Verwendung von ONTAP 9.16.1 oder höher besteht die Möglichkeit, bestimmte rechenintensive Operationen wie Verschlüsselung und Integritätsprüfungen auf eine Netzwerkschnittstellenkarte (NIC), die im Speicherknoten installiert ist, auszulagern. Die Auswirkungen auf die Netzwerkdurchsatzleistung durch die Auslagerung der IPsec-Verschlüsselungsoperationen auf die NIC-Karte betragen im Vergleich zu Klartextoperationen ohne aktivierte IPsec-Verschlüsselung etwa 5 % oder weniger. Dadurch können die Leistung und der Durchsatz des durch IPsec geschützten Netzwerkverkehrs erheblich verbessert werden.
...
* X50131A (IO Modul, 2PT, 100/200GbE)
* X50131B (E/A-Modul, 2PT, 200/400GbE,B)
* X60132A (4p, 10G/25G-Ethernet-Controller)


ONTAP 9.17.1 bietet Unterstützung für die folgenden Ethernet Karten:

* X50135A (IO Modul, 2PT, 100GbE, Verschlüsselung)
