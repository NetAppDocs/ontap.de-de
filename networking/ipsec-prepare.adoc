...
|===
Weitere Informationen zur ONTAP REST-API einschließlich https://docs.netapp.com/us-en/ontap-automation/whats-new.html["Neuerungen bei der ONTAP REST API"^]finden Sie auf der Dokumentationswebsite zur ONTAP Automatisierung. Weitere Informationen zu den IPsec-Endpunkten finden Sie in derONTAP https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html["API-Referenz"^]-Dokumentation.
