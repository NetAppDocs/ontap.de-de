...
Erfahren Sie mehr über `network port ifgrp add-port` in der link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["ONTAP-Befehlsreferenz"^]. Erfahren Sie mehr über `network port ifgrp add-port` in der link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["ONTAP-Befehlsreferenz"^].
...
Erfahren Sie mehr über `network port ifgrp delete` in der link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["ONTAP-Befehlsreferenz"^]. Erfahren Sie mehr über `network port ifgrp delete` in der link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["ONTAP-Befehlsreferenz"^].
