...
Informationen über die Auswirkungen der Netzwerkfunktionen, die mit jeder ONTAP 9-Version verfügbar sind, finden Sie unter link:../release-notes/index.html["Versionshinweise zu ONTAP"].
