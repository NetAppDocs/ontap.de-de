...
---
= Informationen zu internen Ports von ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Die folgende Tabelle listet die von ONTAP intern verwendeten Ports und deren Funktionen auf. ONTAP nutzt diese Ports für verschiedene Funktionen, wie zum Beispiel für die Herstellung der Intracluster-LIF-Kommunikation.

Diese Liste ist nicht vollständig und kann je nach Umgebung variieren.
...
| 930 | Kernel-Services und Managementfunktionen (KSMF) 
...
| 5125 | Alternativer Steuerport für Festplatte 


| 5133 | Alternativer Steuerport für Festplatte 


| 5144 | Alternativer Steuerport für Festplatte 
