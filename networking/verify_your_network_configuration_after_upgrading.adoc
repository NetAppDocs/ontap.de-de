...
[role="lead"]
Nach einem Upgrade auf ONTAP 9.8 sollten Sie die Netzwerkkonfiguration überprüfen. Nach dem Upgrade überwacht ONTAP automatisch die Erreichbarkeit von Ebene 2.

Mit dem folgenden Befehl können Sie überprüfen, ob jeder Port seine erwartete Broadcast-Domäne wieder verfügbar ist:
