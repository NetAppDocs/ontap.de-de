...
Wenn der Home Port einer LIF auf einen anderen Knoten verschoben wird oder gelöscht wird, gilt die LIF als „vertrieben“. Sie können diese vertriebenen LIFs mit dem folgenden Befehl anzeigen:
