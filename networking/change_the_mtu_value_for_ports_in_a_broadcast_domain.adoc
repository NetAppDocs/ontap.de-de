...
.System Manager
--
Ab ONTAP 9.12.1 können Sie den System Manager verwenden, um den MTU-Wert für eine Broadcast-Domäne zu ändern und so den MTU-Wert für alle Ports in dieser Broadcast-Domäne zu ändern.
