...
. Ab ONTAP 9.9.1 ist kein Neustart mehr erforderlich. Wenn Sie ONTAP 9.8 oder älter verwenden, müssen Sie jeden Knoten im Cluster einzeln manuell neu starten.
