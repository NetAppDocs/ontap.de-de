...
Erfahren Sie mehr über link:https://docs.netapp.com/us-en/ontap/volumes/logical-space-reporting-enforcement-concept.html["ONTAP Release-Unterstützung für Berichterstellung zum logischen Speicherplatz"].
