...
summary: Der Root-Benutzer auf UNIX-Clients unterliegt zwar Baumkontingenten, jedoch nicht Benutzer- oder Gruppenkontingenten. Dadurch kann der Root-Benutzer im Namen anderer Benutzer Aktionen ausführen, die andernfalls durch ein Kontingent verhindert würden. 
---
