...
Verwandte Informationen: link:../data-protection/convert-snapmirror-version-flexible-task.html["Konvertieren einer vorhandenen ONTAP SnapMirror-DP-Beziehung in XDP"]
