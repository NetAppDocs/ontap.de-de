...
Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/volumes/storage-efficiency-behavior-snapmirror-reference.html["Storage-Effizienzverhalten bei Volume-Verschiebung und SnapMirror Operationen"].
