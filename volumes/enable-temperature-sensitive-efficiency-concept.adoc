...
Bei vorhandenen Volumes wird temperaturempfindliche Storage-Effizienz nicht automatisch aktiviert, Sie können jedoch link:https://docs.netapp.com/us-en/ontap/volumes/change-efficiency-mode-task.html["Ändern Sie den Storage-Effizienz-Modus"]manuell in den effizienten Modus wechseln.
