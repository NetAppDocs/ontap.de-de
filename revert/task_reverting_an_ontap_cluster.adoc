...
. Wiederholen <<step-5>> Bis <<step-17>> Auf dem anderen Node im HA-Paar.
...
. Wiederholen <<step-6>> Bis <<step-18>> Für jedes zusätzliche HA-Paar und für die Cluster in der MetroCluster-Konfiguration.
