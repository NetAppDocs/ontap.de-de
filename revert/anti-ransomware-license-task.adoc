...
Die Volumes mit vorhandenem Schutz funktionieren nach Zurücksetzen weiterhin ordnungsgemäß und der ARP-Status kann mithilfe der ONTAP-CLI angezeigt werden. System Manager kann jedoch keinen ARP-Status ohne die MTKM-Lizenz anzeigen.
