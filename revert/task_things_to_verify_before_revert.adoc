...
summary: Bevor Sie ONTAP zurücksetzen, sollten Sie den Zustand Ihres Clusters, Ihres Speichers und die Systemzeit überprüfen. Sie sollten außerdem überprüfen, dass keine Jobs auf dem Cluster ausgeführt werden. 
---
