...
Wenn Sie von ONTAP 9.12.1 oder höher auf ONTAP 9.12.0 oder früher zurücksetzen, müssen Sie dies tun link:..nvme/disable-secure-authentication-nvme-task.html["Deaktivieren Sie die in-Band-Authentifizierung"] Bevor Sie zurückkehren.  Wenn die bandinterne Authentifizierung mit DH-HMAC-CHAP nicht deaktiviert ist, schlägt die Wiederherstellung fehl.
