...
summary: Es wird erläutert, wie festgestellt werden kann, ob ein gemeldetes ONTAP ARP- oder ARP/AI-Ereignis ein tatsächlicher Ransomware-Angriff oder ein Fehlalarm ist und wie darauf reagiert werden kann. 
---
...
Erscheint die Warnung innerhalb weniger Stunden oder Tage nach Aktivierung des Autonomous Ransomware Protection, handelt es sich wahrscheinlich um einen Fehlalarm. Treten nach der Aktivierung des Autonomous Ransomware Protection mehrere Tage lang keine Warnungen auf und erscheint dann eine Warnung, ist die Wahrscheinlichkeit eines tatsächlichen Angriffs höher.
...
* link:respond-arpai.html["Auf abnormale Aktivität reagieren: ARP/AI (ONTAP 9.16.1 und höher)"]
* link:respond-arp.html["Auf abnormale Aktivität reagieren: ARP (ONTAP 9.15.1 und früher)"]
