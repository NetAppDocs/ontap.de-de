...
* Das Volumen, auf dem Sie ARP setzen möchten, muss geschützt sein und über einen aktiven verfügen link:../concepts/namespaces-junction-points-concept.html["Verbindungspfad"^].
