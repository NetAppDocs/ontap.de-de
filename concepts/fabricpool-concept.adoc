...
summary: Viele NetApp Kunden haben erhebliche Mengen gespeicherter Daten, auf die selten zugegriffen wird. Das nennen wir kalte Daten. Kunden haben auch Daten, auf die häufig zugegriffen wird, die wir heiße Daten nennen. Idealerweise möchten Sie Ihre heißen Daten auf Ihrem schnellsten Speicher aufbewahren, um die beste Performance zu erzielen. Kalte Daten können auf langsameren Speicher verschoben werden, solange sie bei Bedarf sofort verfügbar sind. Erfahren Sie, wie Sie erkennen, welche Teile Ihrer Daten heiß und welche kalt sind. 
---
= FabricPool
:allow-uri-read: 
:icons: font
...
link:../concept_cloud_overview.html["Dokument für FabricPool System Manager"]
