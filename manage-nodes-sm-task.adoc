...
NOTE: Dieses Verfahren gilt für FAS, AFF und aktuelle ASA Systeme. Wenn Sie über ein ASA r2-System verfügen (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30 oder ASA A20), befolgen Sie  die Anweisungen link:https://docs.netapp.com/us-en/asa-r2/administer/reboot-take-over-give-back-nodes.html["Diesen Schritten ausführen"^] zum Herunterfahren und Neustarten eines Knotens. ASA r2 Systeme bieten eine vereinfachte ONTAP-Erfahrung speziell für reine SAN-Kunden.
