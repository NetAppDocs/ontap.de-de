...
Ab ONTAP 9.19.1 unterstützt ARP/AI primäre Volumes, die an SnapMirror Aktiv Sync SAN-Beziehungen teilnehmen. Weitere Informationen finden Sie unter link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["Anwendungsfälle und Überlegungen zum autonomen Ransomware-Schutz"].
