...
Ab ONTAP 9.19.1 RC unterstützt ARP/AI primäre Volumes, die an SnapMirror active sync SAN-Beziehungen teilnehmen. Weitere Informationen finden Sie unter link:../anti-ransomware/use-cases-restrictions-concept.html#interoperability-and-vm-considerations["Anwendungsfälle und Überlegungen zum autonomen Ransomware-Schutz"].
