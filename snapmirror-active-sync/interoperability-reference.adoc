...
Ab ONTAP 9.11.1 wird AIX mit SnapMirror Active Sync über Standard Engineering PVR unterstützt mit der Vereinbarung, dass die folgenden Bedingungen verstanden werden:
