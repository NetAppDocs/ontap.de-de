...
In asymmetrischen Aktiv/Passiv-Konfigurationen werden Daten am sekundären Standort an eine LUN, einen Namespace oder eine Speichereinheit weitergeleitet.
...
Die Funktionen „Primär zuerst“ und „Primär Bias“ werden in SnapMirror active sync ab ONTAP 9.15.1 unterstützt. Primäre Kopien werden im System Manager festgelegt und mit der ONTAP REST API und ONTAP CLI ausgegeben.
...
* NVMe für VMware-Workloads
 ...
 a| 
* Asymmetrisch Aktiv/Passiv



NOTE: Asymmetrisch Aktiv/Passiv unterstützt ASA r2 und NVMe nicht. Weitere Informationen zur NVMe-Unterstützung finden Sie unter link:../nvme/support-limitations.html["Konfiguration, Support und Einschränkungen von NVMe"].
...
* FC
 ...
 a| 
* Asymmetrisch Aktiv/Passiv
* Symmetrische Aktiv/Aktiv-Konfigurationen unterstützen 4-Knoten-zu-4-Knoten-Cluster in ONTAP 9.16.1 und höher. Für ASA r2 werden nur 2-Knoten-Cluster unterstützt.
...
* FC
 ...
 a| 
* Asymmetrisch Aktiv/Passiv
* Symmetrische Aktiv/Aktiv Aktiv/Aktiv-Konfigurationen unterstützen 2-Knoten-Cluster in ONTAP 9.15.1. 2-Knoten-zu-2-Knoten-Cluster und 4-Knoten-zu-4-Knoten-Cluster werden in ONTAP 9.16.1 und später unterstützt.
