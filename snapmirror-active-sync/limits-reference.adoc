...
IMPORTANT: Diese Grenzwerte gelten für FAS, AFF und aktuelle ASA Systeme. Wenn Sie über ein ASA r2-System verfügen (ASA A1K, ASA A70 oder ASA A90), siehe link:https://docs.netapp.com/us-en/asa-r2/data-protection/manage-consistency-groups.html["ASA r2 Dokumentation"^].
