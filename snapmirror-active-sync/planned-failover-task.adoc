...
. Identifizieren Sie die SnapMirror Active Sync Beziehung, die Sie für ein Failover verwenden möchten. Wählen Sie neben dem Namen den aus `...` Wählen Sie neben dem Namen der Beziehung die Option **Failover**.
