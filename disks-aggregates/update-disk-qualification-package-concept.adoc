...
summary: Das Disk Qualification Package, oder DQP, bietet volle Unterstützung für neu qualifizierte Laufwerke. Bevor Sie die Firmware eines Laufwerks aktualisieren oder neue Laufwerkstypen oder -größen zu einem Cluster hinzufügen, müssen Sie das DQP aktualisieren. Eine Best Practice ist es auch, das DQP regelmäßig zu aktualisieren. 
---
