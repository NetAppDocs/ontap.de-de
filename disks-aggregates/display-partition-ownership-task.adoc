...
summary: Sie können die Datenträgerbesitzverhältnisse einsehen, um festzustellen, welcher Knoten den Speicher kontrolliert. Sie können außerdem auf Systemen mit gemeinsam genutzten Datenträgern die Partitionsbesitzverhältnisse einsehen. 
---
= Anzeige von ONTAP Festplatten- und Partitionszuordnungen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. Besitzverhältnisse der physischen Datenträger werden angezeigt:
+
...
....
. Wenn ein System mit gemeinsam genutzten Festplatten verwendet wird, lässt sich die Partitionszugehörigkeit anzeigen:
+
