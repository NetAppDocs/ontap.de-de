...
. Wählen Sie image:icon_kabob.gif["Kabob-Symbol"] Dann *Flash Pool Cache hinzufügen*.
...
. Suchen Sie die Speicherebene und wählen Sie aus image:icon_kabob.gif["Kabob-Symbol"].
