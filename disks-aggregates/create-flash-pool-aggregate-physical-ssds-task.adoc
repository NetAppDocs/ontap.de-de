...
summary: Sie erstellen eine lokale Flash-Pool-Ebene, indem Sie die Funktion auf einer bestehenden lokalen Ebene aktivieren, die aus HDD-RAID-Gruppen besteht, und anschließend eine oder mehrere SSD-RAID-Gruppen zu dieser lokalen Ebene hinzufügen. Dadurch entstehen zwei Sätze von RAID-Gruppen für diese lokale Ebene, nämlich die SSD-RAID-Gruppen bzw. der SSD-Cache und die HDD-RAID-Gruppen. 
---
