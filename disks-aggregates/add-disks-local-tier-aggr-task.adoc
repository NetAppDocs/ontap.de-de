...
. Wählen Sie das Aggregat aus, zu dem Sie Kapazitätsfestplatten hinzufügen möchten, und wählen Sie dann *Actions > Add Capacity* aus.
+
...
. Wählen Sie *Speicher > Tiers*, um die Größe des neuen Aggregats zu überprüfen.
...
.Über diese Aufgabe
Dieses Verfahren zum Hinzufügen partitionierter Festplatten zu einem Aggregat ähnelt dem Verfahren zum Hinzufügen nicht partitionierter Festplatten.
