...
+
** Der `-data1 true` Parameter weist die Partition „`data1`“ einer partitionierten Root-data1-data2-Festplatte zu.
** Der `-data2 true` Parameter weist die Partition „`data2`“ einer partitionierten Root-data1-data2-Festplatte zu.
