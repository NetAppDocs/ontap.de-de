...
* Bei Flash Pool Aggregaten sollten Sie mindestens zwei Ersatzfestplatten pro HA-Paar haben. Weitere Informationen zu den unterstützten RAID-Richtlinien für Flash Pool Aggregate finden Sie in https://["Hardware Universe"^].
...
http://["Technischer Bericht 3838 von NetApp zur Konfiguration von Storage-Subsystemen"^]
