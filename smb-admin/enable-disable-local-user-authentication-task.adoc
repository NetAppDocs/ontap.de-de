...
summary: Sie können die lokale Benutzerauthentifizierung für den SMB-Zugriff auf Storage Virtual Machines aktivieren oder deaktivieren. Standardmäßig ist die Benutzerauthentifizierung erlaubt, was nützlich ist, wenn die SVM keinen Domänencontroller erreichen kann oder wenn Sie keine Zugriffskontrollen auf Domänenebene verwenden möchten. 
---
