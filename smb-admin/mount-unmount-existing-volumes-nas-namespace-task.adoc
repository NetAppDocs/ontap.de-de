...
summary: Bevor Sie den NAS-Client-Zugriff auf die Daten in den Volumes der Storage Virtual Machine konfigurieren können, muss ein Volume im NAS-Namespace eingebunden sein. Sie können ein Volume an einem Verbindungspunkt einbinden, wenn es derzeit nicht eingebunden ist. Sie können Volumes auch aushängen. 
---
