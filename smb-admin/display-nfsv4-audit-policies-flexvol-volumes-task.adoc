...
summary: Sie können Informationen zu NFSv4-Überwachungsrichtlinien auf FlexVol-Volumes mithilfe der ONTAP CLI anzeigen, einschließlich der Sicherheitsstile und effektiven Sicherheitsstile, der angewendeten Berechtigungen sowie Informationen zu Systemzugriffskontrolllisten. Sie können die Ergebnisse zur Validierung Ihrer Sicherheitskonfiguration oder zur Fehlerbehebung bei Audit-Problemen verwenden. 
---
