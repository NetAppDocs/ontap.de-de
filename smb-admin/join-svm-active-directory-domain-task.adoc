...
summary: 'Sie können eine Storage Virtual Machine in eine Active Directory-Domäne einbinden, ohne den vorhandenen SMB-Server zu löschen, indem Sie die Domäne mit dem Befehl `vserver cifs modify` ändern. Sie können der aktuellen Domäne wieder beitreten oder einer neuen beitreten.' 
---
