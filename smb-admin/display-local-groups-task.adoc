...
summary: Sie können eine Liste aller im Cluster oder auf einer angegebenen Storage Virtual Machine konfigurierten lokalen Gruppen anzeigen. Diese Informationen können bei der Fehlerbehebung von Dateizugriffsproblemen auf Daten, die sich auf der SVM befinden, oder von Benutzerberechtigungsproblemen auf der SVM hilfreich sein. 
---
