...
summary: Wenn Sie die Gruppenrichtlinienobjekteinstellungen auf Ihrem CIFS-Server sofort aktualisieren möchten, können Sie die Einstellungen manuell aktualisieren. Sie können entweder nur die geänderten Einstellungen aktualisieren oder eine Aktualisierung aller Einstellungen erzwingen, einschließlich der Einstellungen, die zuvor angewendet wurden, sich aber nicht geändert haben. 
---
