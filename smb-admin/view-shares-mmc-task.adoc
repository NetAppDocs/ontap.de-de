...
summary: Sie können Informationen zu SMB-Freigaben auf Ihrer SVM anzeigen und einige Verwaltungsaufgaben mithilfe der Microsoft Management Console durchführen. Bevor Sie die Freigaben anzeigen können, müssen Sie die MMC mit der SVM verbinden. 
---
