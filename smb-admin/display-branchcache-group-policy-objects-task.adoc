...
summary: Sie können Informationen zur Gruppenrichtlinienobjektkonfiguration des CIFS-Servers anzeigen, um festzustellen, ob BranchCache-Gruppenrichtlinienobjekte für die Domäne, zu der der CIFS-Server gehört, definiert sind und, falls ja, welche zulässigen Einstellungen vorhanden sind. Sie können außerdem feststellen, ob BranchCache-Gruppenrichtlinienobjekteinstellungen auf den CIFS-Server angewendet werden. 
---
