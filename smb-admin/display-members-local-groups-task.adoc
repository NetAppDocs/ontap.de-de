...
summary: Sie können eine Liste aller Mitglieder lokaler Gruppen anzeigen, die im Cluster oder auf einer bestimmten Storage Virtual Machine konfiguriert sind. Diese Informationen können bei der Behebung von Dateizugriffs- oder Benutzerberechtigungsproblemen hilfreich sein. 
---
