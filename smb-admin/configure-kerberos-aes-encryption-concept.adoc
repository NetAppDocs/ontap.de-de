...
summary: Für maximale Sicherheit bei Kerberos-basierter Kommunikation können Sie die AES-256- und AES-128-Verschlüsselung auf dem SMB-Server aktivieren. Standardmäßig ist die Advanced Encryption Standard-Verschlüsselung beim Erstellen eines SMB-Servers auf der SVM deaktiviert. Sie müssen sie aktivieren, um die starke Sicherheit der AES-Verschlüsselung nutzen zu können. 
---
