...
summary: Wenn Sie einen CIFS-Server auf Ihrer Storage Virtual Machine erstellen, werden automatisch standardmäßige administrative Freigaben angelegt. Sie sollten verstehen, was diese Standardfreigaben sind und wie sie verwendet werden. 
---
