...
summary: Die Namen von Home-Verzeichnisfreigaben müssen entweder den Windows-Benutzernamen oder die dynamische Variable für den UNIX-Benutzernamen enthalten. Sie sollten sich darüber im Klaren sein, was mit bestehenden statischen Home-Verzeichnisfreigabenamen nach einem Upgrade auf eine Version von ONTAP mit dieser neuen Anforderung geschieht. 
---
