...
summary: Sie können Informationen zu den SMB-Server-Sicherheitseinstellungen auf Ihren Storage Virtual Machines anzeigen lassen. Mithilfe dieser Informationen können Sie überprüfen, ob die Sicherheitseinstellungen korrekt sind. 
---
