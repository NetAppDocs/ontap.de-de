...
summary: Das Erstellen eines NTFS-Sicherheitsdeskriptors ist der erste Schritt beim Konfigurieren und Anwenden von NTFS-Zugriffskontrolllisten auf Dateien und Ordner in Storage Virtual Machines. Sie können den Sicherheitsdeskriptor in einer Richtlinienaufgabe dem Datei- oder Ordnerpfad zuordnen. 
---
