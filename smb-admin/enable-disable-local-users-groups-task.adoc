...
summary: Sie können lokale Benutzer und Gruppen für den SMB-Zugriff auf Storage Virtual Machines aktivieren oder deaktivieren. Die Funktionalität für lokale Benutzer und Gruppen ist standardmäßig aktiviert. 
---
