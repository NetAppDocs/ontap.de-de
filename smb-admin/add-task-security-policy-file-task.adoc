...
Beim Hinzufügen von Aufgaben zu Sicherheitsrichtlinien müssen die folgenden vier erforderlichen Parameter angegeben werden:

* SVM-Name
* Richtlinienname
* Pfad
* Sicherheitsdeskriptor, der dem Pfad zugeordnet wird
