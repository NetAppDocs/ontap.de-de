...
summary: Sie können eine lokale Gruppe aus der Storage Virtual Machine löschen, wenn sie nicht mehr benötigt wird, um Zugriffsrechte auf Daten zu ermitteln, die dieser SVM zugeordnet sind, oder wenn sie nicht mehr benötigt wird, um SVM-Benutzerrechte an Gruppenmitglieder zuzuweisen. 
---
