...
summary: Wenn Ihre BranchCache-Konfiguration das Caching auf allen SMB-Freigaben auf jeder Storage Virtual Machine automatisch aktiviert, können Sie die BranchCache-Konfiguration so ändern, dass das automatische Caching von Inhalten für alle SMB-Freigaben gestoppt wird. 
---
