...
summary: Ab ONTAP 9.3 können Sie den Standardprozess zur Erkennung von Domänencontrollern anpassen. Dadurch können Sie die Erkennung auf Ihren Standort oder auf eine Gruppe bevorzugter DCs beschränken, was je nach Umgebung zu Leistungsverbesserungen führen kann. 
---
