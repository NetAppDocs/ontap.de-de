...
summary: Ab ONTAP 9 ist der NetBios-Namensdienst standardmäßig deaktiviert. Bisher sendeten CIFS-fähige virtuelle Speichermaschinen Namensregistrierungs-Broadcasts, unabhängig davon, ob WINS im Netzwerk aktiviert war. Um diese Broadcasts auf Konfigurationen zu beschränken, in denen NBNS erforderlich ist, muss NBNS für neue CIFS-Server explizit aktiviert werden. 
---
