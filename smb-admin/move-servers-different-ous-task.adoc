...
summary: Der CIFS-Server-Erstellungsprozess verwendet während der Einrichtung standardmäßig die Organisationseinheit CN-Computers, sofern Sie keine andere OU angeben. Sie können CIFS-Server nach der Einrichtung in andere OUs verschieben. 
---
