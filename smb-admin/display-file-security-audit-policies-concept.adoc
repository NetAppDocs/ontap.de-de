...
summary: Sie können Informationen zur Dateisicherheit von Dateien und Verzeichnissen in Volumes auf Storage Virtual Machines anzeigen. Sie können Informationen zu Überwachungsrichtlinien auf FlexVol-Volumes anzeigen. Wenn konfiguriert, können Sie Informationen zu Storage-Level Access Guard und Dynamic Access Control Sicherheitseinstellungen auf FlexVol-Volumes anzeigen. 
---
