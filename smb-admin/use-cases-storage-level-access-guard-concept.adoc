...
summary: Storage-Level Access Guard bietet zusätzliche Sicherheit auf Speicherebene, die für Clients nicht sichtbar ist. Daher kann sie von keinem Benutzer oder Administrator von seinem Desktop aus aufgehoben werden. Es gibt bestimmte Anwendungsfälle, in denen die Möglichkeit, den Zugriff auf Speicherebene zu kontrollieren, von Vorteil ist. 
---
