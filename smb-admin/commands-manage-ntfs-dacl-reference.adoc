...
summary: Es gibt spezielle ONTAP-Befehle zur Verwaltung von DACL-Zugriffskontrolleinträgen. Sie können NTFS-DACLs jederzeit ACEs hinzufügen. Sie können außerdem bestehende NTFS-DACLs verwalten, indem Sie ACEs in DACLs ändern, löschen und Informationen dazu anzeigen. 
---
