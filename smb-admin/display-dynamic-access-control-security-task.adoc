...
summary: Sie können Informationen zur Dynamic Access Control-Sicherheit auf NTFS-Volumes und zu Daten mit effektiver NTFS-Sicherheit auf Volumes mit gemischtem Sicherheitsstil anzeigen. Dies umfasst Informationen zu bedingten ACEs, Ressourcen-ACEs und zentralen Zugriffsrichtlinien-ACEs. Sie können die Ergebnisse verwenden, um Ihre Sicherheitskonfiguration zu validieren oder Probleme beim Dateizugriff zu beheben. 
---
