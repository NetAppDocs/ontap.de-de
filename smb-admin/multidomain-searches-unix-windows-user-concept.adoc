...
Ab ONTAP 9.13.1 führt ONTAP bei der Suche nach vertrauenswürdigen Domänen während Namenszuordnungsvorgängen für mehrere Domänen eine Standortermittlung für diese vertrauenswürdigen Domänen durch und verwendet den ermittelten Standort für Domänencontroller-Abfragen. Dadurch wird sichergestellt, dass DNS-SRV-Abfragen die korrekten Standortinformationen für Domänencontroller vertrauenswürdiger Domänen verwenden. Wenn die Standortermittlung für vertrauenswürdige Domänen fehlschlägt, verwendet ONTAP den Standardstandort des SMB-Servers.
