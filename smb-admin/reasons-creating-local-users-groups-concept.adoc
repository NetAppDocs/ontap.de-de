...
summary: Es gibt mehrere Gründe, lokale Benutzer und lokale Gruppen auf Ihrer Storage Virtual Machine anzulegen. Beispielsweise können Sie über ein lokales Benutzerkonto auf einen SMB-Server zugreifen, wenn die Domänencontroller nicht verfügbar sind, Sie möchten möglicherweise lokale Gruppen verwenden, um Berechtigungen zuzuweisen, oder Ihr SMB-Server befindet sich in einer Arbeitsgruppe. 
---
