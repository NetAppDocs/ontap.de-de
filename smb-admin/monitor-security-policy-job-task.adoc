...
summary: Beim Anwenden der Sicherheitsrichtlinie auf Storage Virtual Machines können Sie den Fortschritt der Aufgabe überwachen, indem Sie den Sicherheitsrichtlinien-Job überwachen. Dies ist hilfreich, wenn Sie sicherstellen möchten, dass die Anwendung der Sicherheitsrichtlinie erfolgreich war. Dies ist auch hilfreich, wenn Sie einen lang andauernden Job haben, bei dem Sie die Sicherheit für eine große Anzahl von Dateien und Ordnern anwenden. 
---
