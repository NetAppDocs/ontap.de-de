...
summary: Wenn Sie zuvor BranchCache konfiguriert haben, aber nicht möchten, dass die Storage Virtual Machine weiterhin zwischengespeicherte Inhalte bereitstellt, können Sie die BranchCache-Konfiguration auf dem CIFS-Server löschen. Sie müssen sich darüber im Klaren sein, was passiert, wenn Sie die Konfiguration löschen. 
---
