...
summary: Herkömmliche Oplocks und Lease-Oplocks ermöglichen es einem SMB-Client in bestimmten Dateifreigabeszenarien, Client-seitig Caching von Read-Ahead-, Write-Behind- und Sperrinformationen durchzuführen. Ein Client kann dann von einer Datei lesen oder in eine Datei schreiben, ohne den Server regelmäßig daran zu erinnern, dass er Zugriff auf die betreffende Datei benötigt. Dies verbessert die Leistung durch Reduzierung des Netzwerkverkehrs. 
---
