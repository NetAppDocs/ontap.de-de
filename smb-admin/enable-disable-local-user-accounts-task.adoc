...
summary: Sie aktivieren ein lokales Benutzerkonto, wenn der Benutzer über eine SMB-Verbindung auf die in der Storage Virtual Machine enthaltenen Daten zugreifen soll. Sie können ein lokales Benutzerkonto auch deaktivieren, wenn der Benutzer nicht über SMB auf SVM-Daten zugreifen soll. 
---
