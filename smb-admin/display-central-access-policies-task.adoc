...
summary: Sie können detaillierte Informationen zu den in Active Directory definierten zentralen Zugriffsrichtlinien anzeigen. Sie können außerdem Informationen zu den zentralen Zugriffsrichtlinien anzeigen, die auf den CIFS-Server über Gruppenrichtlinienobjekte angewendet werden. 
---
