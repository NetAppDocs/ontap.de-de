...
summary: Server Message Block ist ein Remote-Dateifreigabeprotokoll, das von Microsoft Windows-Clients und -Servern verwendet wird. Alle SMB-Versionen werden unterstützt. Sie sollten überprüfen, ob der ONTAP SMB-Server die in Ihrer Umgebung benötigten Clients und Funktionen unterstützt. 
---
