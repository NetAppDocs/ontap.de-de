...
summary: Für die Verwaltung von SACL-Zugriffskontrolleinträgen stehen spezielle ONTAP-Befehle zur Verfügung. Sie können ACEs zu NTFS-SACLs jederzeit hinzufügen. Sie können außerdem bestehende NTFS-SACLs verwalten, indem Sie ACEs in SACLs ändern, löschen und Informationen dazu anzeigen. 
---
