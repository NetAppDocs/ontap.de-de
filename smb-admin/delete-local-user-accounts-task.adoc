...
summary: Sie können lokale Benutzerkonten von Ihrer Storage Virtual Machine löschen, wenn diese nicht mehr für die lokale SMB-Authentifizierung am CIFS-Server oder zur Ermittlung der Zugriffsrechte auf die auf Ihrer SVM enthaltenen Daten benötigt werden. 
---
