...
summary: Sie können eine Home Directory-Konfiguration mithilfe des Windows-Benutzernamens und der Home Directory-Variablen erstellen. Benutzer können sich dann über dynamisch erstellte Freigaben mit ihrer Home Directory-Freigabe verbinden. 
---
