...
summary: Das Erstellen einer NTFS-Sicherheitsdeskriptor-Überwachungsrichtlinie ist der erste Schritt beim Konfigurieren und Anwenden von NTFS-Zugriffskontrolllisten auf Dateien und Ordner in SVMs. Sie ordnen den Sicherheitsdeskriptor dem Datei- oder Ordnerpfad in einer Richtlinienaufgabe zu. 
---
