...
----
+
Eine vollständige Befehlssyntax finden Sie im link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-quiesce.html["Man-Page"^].
...
----
+
Eine vollständige Befehlssyntax finden Sie im link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-break.html["Man-Page"^].
...
----
+
Eine vollständige Befehlssyntax finden Sie im link:https://docs.netapp.com/us-en/ontap-cli/snapmirror-delete.html["Man-Page"^].
