...
* Die ONTAP-Version auf dem Ziel-Cluster darf nicht mehr als zwei Versionen neuer sein, wie in der Tabelle unten gezeigt.
+
...
Um die Unterstützung zu ermitteln, suchen Sie die Quellversion in der linken Tabellenspalte und suchen Sie dann die Zielversion in der oberen Zeile.
