...
NOTE: ONTAP 9.16.0 bildet eine Ausnahme von der Regel, dass nur Cloud-Lösungen verfügbar sind, da es Unterstützung für Folgendes bietet:link:https://docs.netapp.com/us-en/asa-r2/learn-more/software-support-limitations.html["ASA r2-Systeme"] Die  Das Pluszeichen (+) nach der Versionsnummer kennzeichnet eine Version, die sowohl von ASA r2 als auch von der Cloud unterstützt wird.  ASA r2-Systeme unterstützen SnapMirror Beziehungen nur zu anderen ASA r2-Systemen.
