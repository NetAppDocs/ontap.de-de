...
|===
| ONTAP-Version… 23+| Interagiert mit diesen früheren ONTAP-Versionen… 


|  | 9.19.1 | 9.18.1 | 9.17.1 | 9.16.1 | 9.16.0+ | 9.15.1 | 9.15.0* | 9.14.1 | 9.14.0* | 9.13.1 | 9.13.0* | 9.12.1 | 9.12.0* | 9.11.1 | 9.11.0* | 9.10.1 | 9.10.0* | 9.9.1 | 9.9* | 9,8 | 9,7 | 9,6 | 9,5 
...
| 9.9* | Nein | Nein | Nein | Nein | Nein | Nein | Nein | *Ja* | Nein | *Ja* | Nein | *Ja* | Nein | *Ja* | Nein | *Ja* | Nein | *Ja* | *Ja* | *Ja* | *Ja* | *Ja* | *Ja* 
...
====
|===
| ONTAP-Version… 15+| Interagiert mit diesen früheren ONTAP-Versionen… 
...
* Sie können SVM DR verwenden, um eine SVM zu migrieren, die die angegebenen Einschränkungen nicht erfüllt. link:../svm-migrate/index.html#prerequisites["SVM-Migration (SVM-Datenmobilität)"]Die
...
NOTE: Wenn Sie ONTAP 9.10.1 oder höher verwenden, können Sie die link:../svm-migrate/index.html["SVM-Datenmobilität"] Funktion anstelle von SVM DR, um SVMs von einem Cluster in einen anderen zu migrieren.

|===
| Quelle 23+| Ziel 


|  | 9,5 | 9,6 | 9,7 | 9,8 | 9.9* | 9.9.1 | 9.10.0* | 9.10.1 | 9.11.0* | 9.11.1 | 9.12.0* | 9.12.1 | 9.13.0* | 9.13.1 | 9.14.0* | 9.14.1 | 9.15.0* | 9.15.1 | 9.16.0 | 9.16.1 | 9.17.1 | 9.18.1 | 9.19.1 
