...
NOTE: Die Versionsunabhängigkeit wird bei der SVM-Replizierung nicht unterstützt.
...
| 9.10.2 | Nein | Nein | Nein | Nein | Nein | Nein | Nein | *Ja* | *Ja* | *Ja* 
|===
...
+
Die SVM-Disaster Recovery wird nur zwischen Clustern unterstützt, auf denen dieselbe Version von ONTAP ausgeführt wird.
...
* Die ONTAP-Version im Ziel-Cluster darf, wie in der Tabelle unten gezeigt, nicht höher als zwei neuere On-Premises-Versionen oder zwei Cloud-Versionen sein.
+
...
Um die Unterstützung zu ermitteln, suchen Sie die Quellversion in der linken Tabellenspalte (DR), und suchen Sie dann die Zielversion in der oberen Zeile (DR/Migration).
