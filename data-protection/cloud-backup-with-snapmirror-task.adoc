...
[role="lead"]
Ab ONTAP 9.9.1 können Sie SnapMirror cloud nutzen, wenn Sie Ihre Datenschutz-Workflows in die Cloud überführen möchten. Anstelle herkömmlicher Backup-to-Tape-Architekturen können Sie Objektspeicher als alternatives Repository für die langfristige Datenaufbewahrung und Archivierung verwenden. Sie können Anbieter wie Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, StorageGRID oder ONTAP S3 als Ihren Cloud-Objektspeicher verwenden.

Ab ONTAP 9.9.1 können Sie mit System Manager Ihre Daten sichern und wiederherstellen.
