...
* SnapMirror-Cloud-Backups unterstützen Fanout-Beziehungen. Das bedeutet, dass SnapMirror Backups gleichzeitig auf zwei verschiedenen Objektspeichern erstellt werden können.
