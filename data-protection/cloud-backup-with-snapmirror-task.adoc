...
---
= Datensicherung in der Cloud mit ONTAP SnapMirror cloud
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
_SnapMirror Cloud_ bietet eine ONTAP Replikation für Objektspeicherziele. Dies ermöglicht es Ihnen, veraltete Backup-to-Tape-Architekturen durch Objektspeicher für die langfristige Datenaufbewahrung und Archivierung zu ersetzen. Sie können Anbieter wie Amazon S3, Alibaba Cloud, Azure Blob, Google Cloud Storage, IBM Cloud Object Storage, NetApp StorageGRID oder ONTAP S3 als Ihren Cloud-Objektspeicher verwenden.


NOTE: Die von SystemManager verwaltete SnapMirror Cloud-Replikation unterstützt nur StorageGrid und ONTAP S3 als Objektspeicherziel. Andere Anbieter werden nicht unterstützt.
