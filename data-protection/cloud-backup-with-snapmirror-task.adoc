...
Ab ONTAP 9.16.1 unterstützt SnapMirror Cloud Backup Fanout-Beziehungen. Das bedeutet, dass SnapMirror Backups gleichzeitig auf zwei verschiedenen Objektspeichern erstellt werden können.
...
NOTE: Wenn Sie ONTAP 9.16.1 verwenden und eine einzelne Datei in der SnapMirror Cloud auf einem FlexGroup Volume wiederherstellen, sollten Sie Dateien nur in einem neuen Verzeichnis im FlexGroup Volume wiederherstellen.
