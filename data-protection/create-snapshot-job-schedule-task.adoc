...
[role="lead"]
Eine Snapshot-Richtlinie erfordert mindestens einen Snapshot-Jobzeitplan. Sie können System Manager oder den `job schedule cron create` Befehl zum Erstellen eines Jobzeitplans verwenden.
