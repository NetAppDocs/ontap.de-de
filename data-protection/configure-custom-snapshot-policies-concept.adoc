...
summary: Eine Snapshot-Richtlinie definiert, wie das System Snapshots erstellt. Die Richtlinie legt fest, wann Snapshots erstellt werden, wie viele Kopien aufbewahrt werden und wie diese benannt werden. 
---
