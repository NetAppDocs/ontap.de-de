...
Erfahren Sie mehr über `snapmirror create`, `snapmirror modify` und `snapmirror restore` in der link:https://docs.netapp.com/us-en/ontap-cli/search.html?q=snapmirror["ONTAP-Befehlsreferenz"^].
