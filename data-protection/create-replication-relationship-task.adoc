...
NOTE: Die vordefinierte Richtlinie `SnapCenterSync` ist vom Typ `Sync`. Diese Richtlinie repliziert alle Snapshot Kopien, die mit `snapmirror-label` „App_consistent“ erstellt wurden.
