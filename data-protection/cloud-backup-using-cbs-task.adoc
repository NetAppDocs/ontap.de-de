...
Cloud Backup unterstützt FlexVol Volumes mit Schreibvorgängen und Datensicherung (DP) Volumes. Ab ONTAP 9.12.1 unterstützt Cloud Backup FlexGroup Volumes und SnapLock Volumes.
