...
NOTE: Ab ONTAP 9.10.1 können Sie StorageGRID als Cloud-Backup-Provider auswählen, allerdings nur, wenn BlueXP  lokal implementiert ist. Der BlueXP-Anschluss muss vor Ort installiert und über die BlueXP Software-as-a-Service (SaaS)-Anwendung verfügbar sein.
