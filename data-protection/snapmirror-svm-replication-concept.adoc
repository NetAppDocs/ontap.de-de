...
Weitere Informationen zur einheitlichen Replizierung mit SnapMirror finden Sie unter link:snapmirror-unified-replication-concept.html["Grundlagen der SnapMirror Unified Replication"].
...
Asynchrone Unterstützung von Konsistenzgruppen
 a| 
Ab ONTAP 9.14.1 werden maximal 32 Disaster-Recovery-Beziehungen für SVMs unterstützt, wenn Konsistenzgruppen vorhanden sind. Siehe link:../consistency-groups/protect-task.html["Sichern einer Konsistenzgruppe"] Und link:../consistency-groups/limits.html["Einschränkungen für Konsistenzgruppen"] Finden Sie weitere Informationen.
