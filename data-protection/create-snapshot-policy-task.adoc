...
summary: Eine Snapshot-Richtlinie legt fest, wann Snapshots erstellt werden, wie viele Kopien aufbewahrt werden und wie diese benannt werden. Eine Snapshot-Richtlinie kann bis zu fünf Auftragspläne enthalten. 
---
