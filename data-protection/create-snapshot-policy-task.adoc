...
summary: 'Eine Snapshot-Richtlinie gibt an, wann Snapshots erstellt werden sollen, wie viele Kopien aufbewahrt werden sollen und wie sie benannt werden sollen. So kann ein System beispielsweise jeden Tag um 12:10 Uhr einen Snapshot erstellen, die beiden neuesten Kopien aufbewahren und sie mit „Daily.timestamp“ benennen. Eine Snapshot-Richtlinie kann bis zu fünf Jobpläne enthalten.' 
---
