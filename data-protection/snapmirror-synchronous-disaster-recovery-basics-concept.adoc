...
| Autonomer Ransomware-Schutz | ONTAP 9.19.1 | Wenn Sie ARP auf Volumes aktivieren, die Teil von SnapMirror synchronen oder SnapMirror active sync-Beziehungen nach dem Upgrade sind, wechselt die Beziehung kurzzeitig in einen nicht synchronisierten Zustand. Dieser Zustand ist vorübergehend, und die Beziehung sollte sich automatisch ohne Eingriff wieder synchronisieren. Weitere Informationen finden Sie unter link:../anti-ransomware/use-cases-restrictions-concept.html["Anwendungsfälle und Überlegungen zum autonomen Ransomware-Schutz"]. 
...
| Disaster Recovery für SVM | ONTAP 9,6  a| 
...
| link:../snaplock/snapshot-lock-concept.html["Manipulationssichere Snapshots"] | ONTAP 9.19.1 | Die Ablaufzeit kann nur bei der Erstellung von Snapshots festgelegt werden. Sie können die Ablaufzeit für bereits vorhandene Snapshots weder festlegen noch verlängern. 
...
* https://www.netapp.com/pdf.html?item=/media/17174-tr4733.pdf["Technischer Bericht 4733 zu NetApp: Synchrone Konfiguration mit SnapMirror und Best Practices"^]
