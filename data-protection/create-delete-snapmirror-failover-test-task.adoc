...
. Wählen Sie image:icon_kabob.gif["alt=Menüoptionen"] Wählen Sie neben der Beziehungsquelle *Test Failover*.
...
. Klicken Sie Auf image:icon_add_blue_bg.gif["alt=Menü „Freigabe hinzufügen“"] Und wählen Sie *Share*.
...
.Schritte
. Wählen Sie auf dem Zielcluster *Schutz > Beziehungen* aus.
. Wählen Sie image:icon_kabob.gif["alt=Menüoptionen"] Wählen Sie neben der Beziehungsquelle *Clean Up Test Failover*.
