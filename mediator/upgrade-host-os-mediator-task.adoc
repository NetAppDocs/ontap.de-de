...
+
Wenn Sie Link Aggregation Control Protocol (LACP) in einer Linux-Umgebung verwenden, müssen Sie den Kernel korrekt konfigurieren und sicherstellen, dass der `sysctl net.ipv4.conf.all.arp_ignore` auf "2" eingestellt ist.
