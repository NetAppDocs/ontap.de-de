...
---
= Aktualisieren Sie das Host-Betriebssystem und ONTAP Mediator
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Um das Host-Betriebssystem für ONTAP Mediator auf eine spätere Version zu aktualisieren, müssen Sie zuerst ONTAP Mediator deinstallieren.
