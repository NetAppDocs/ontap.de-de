...
`ontap-mediator-1.7.0`
 a| 
Die ausführbare Produktinstallation für Version 1.7.0
...
----
. Überprüfen Sie die `ontap-mediator-1.6.0.sig.tsr` Und `ontap-mediator-1.7.0.tsr` Dateien, die die zugehörigen Zertifikate verwenden:
+
`openssl ts -verify`
