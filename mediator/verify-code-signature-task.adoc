...
[NOTE]
====
* Ab dem 15. Juni 2025 ist eine Installation oder ein Upgrade auf ONTAP Mediator 1.9 und 1.8 nicht mehr möglich, da die Zertifikate zur Codesignatur-Verifizierung abgelaufen sind. Installieren Sie stattdessen ONTAP Mediator 1.10 durch.
