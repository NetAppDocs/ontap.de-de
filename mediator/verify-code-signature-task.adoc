...
`ontap-mediator-1.12.0`
 a| 
Die ausführbare Installationsdatei für Version 1.12
...
----
. Überprüfen Sie die  `ontap-mediator-1.12.0.sig.tsr` und  `ontap-mediator-1.12.0.tsr` Dateien mithilfe der zugehörigen Zertifikate:
+
[role="tabbed-block"]
====
.OpenSSL 3.x
