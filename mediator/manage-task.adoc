...
[CAUTION]
====
* Zertifikate von Drittanbietern werden nur mit ONTAP Mediator auf bestimmten ONTAP-Versionen unterstützt. Siehe link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/JiraNgage/CONTAP-243278["NetApp Bugs Online Fehler-ID CONTAP-243278"^].
