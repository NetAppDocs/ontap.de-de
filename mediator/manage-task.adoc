...
NOTE: Für SnapMirror Business Continuity (SM-BC) Cluster und MetroCluster IP-Konfigurationen mit ONTAP Mediator, der mit HTTPS konfiguriert ist, müssen die  `intermediate.crt` und  `root_ca.crt` Zertifikate zu einem ONTAP Cluster hinzugefügt werden. Siehe link:../snapmirror-active-sync/mediator-install-task.html["ONTAP Mediator und Cluster für SnapMirror active sync konfigurieren"] und link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_configuring_the_ontap_mediator_service_from_a_metrocluster_ip_configuration.html["Den ONTAP Mediator für eine MetroCluster IP-Konfiguration konfigurieren"^].
