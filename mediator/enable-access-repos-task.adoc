...
.Vorgehensweise für das Betriebssystem Oracle Linux 10.x
[#OL10x%collapsible]
====
Verwenden Sie dieses Verfahren, wenn Ihr Betriebssystem *Oracle Linux 10.x* ist, um den Zugriff auf Repositories zu aktivieren:
