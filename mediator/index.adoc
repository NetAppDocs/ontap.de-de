...
Stellen Sie sicher, dass die folgenden Ports für ONTAP Mediator verfügbar und nicht belegt sind:
...
|===
Für SMBC-Kunden ist es bei ONTAP nicht erforderlich, dass Port 3260 aktiviert oder verbunden ist.

* Wenn Sie eine Firewall eines Drittanbieters verwenden, siehe link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/concept_mediator_requirements.html#firewall-requirements-for-ontap-mediator["Firewall-Anforderungen für ONTAP Mediator"^].
