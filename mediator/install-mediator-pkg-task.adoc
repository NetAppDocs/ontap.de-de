...
NOTE: Um die automatische Signaturprüfung während der Installation zu überspringen, verwenden Sie den folgenden Befehl:  `./ontap-mediator-1.10/ontap-mediator-1.10 -y --skip-code-signature-check`
