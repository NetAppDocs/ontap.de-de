...
summary: Um den ONTAP Mediator-Dienst zu installieren, müssen Sie das Installationspaket abrufen und das Installationsprogramm auf dem Host ausführen. 
---
...
NOTE: Um die automatische Signaturprüfung während der Installation zu überspringen, verwenden Sie den folgenden Befehl: `./ontap-mediator-1.9.0/ontap-mediator-1.9.0 -y --skip-code-signature-check`
