...
+
Alternativ können Sie die  `--https-only` Option im  `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` Befehl verwenden, um nur HTTPS anzugeben.
...
[NOTE]
====
Um die Signaturprüfung während der Installation zu überspringen, verwenden Sie diesen Befehl: `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
