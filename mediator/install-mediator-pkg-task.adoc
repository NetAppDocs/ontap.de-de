...
[CAUTION]
====
* In MetroCluster IP-Konfigurationen kann eine einzelne ONTAP Mediator-Instanz, wenn der ONTAP Mediator mit dem HTTPS-Protokoll konfiguriert ist, nur eine MetroCluster IP-Konfiguration überwachen. Die Überwachung mehrerer MetroCluster IP-Konfigurationen gleichzeitig wird nicht unterstützt.
