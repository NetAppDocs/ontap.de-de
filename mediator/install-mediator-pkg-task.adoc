...
summary: Um ONTAP Mediator zu installieren, müssen Sie das Installationspaket erhalten und das Installationsprogramm auf dem Host ausführen. 
---
...
[role="lead"]
Um ONTAP Mediator zu installieren, müssen Sie das Installationspaket erhalten und das Installationsprogramm auf dem Host ausführen.
...
NOTE: Um die Signaturprüfung während der Installation zu überspringen, verwenden Sie diesen Befehl: `./ontap-mediator-1.11.0/ontap-mediator-1.11.0 -y --skip-code-signature-check`
...
.Beispiel für die Installation des ONTAP Mediators (Konsolenausgabe)
[%collapsible]
====
[listing]
----
