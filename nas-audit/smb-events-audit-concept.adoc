...
* Wenn das offene Ereignis eine offene Anforderung ist, ein neues Objekt (Datei oder Verzeichnis) zu erstellen, wird das angezeigt `HandleID` Das Tag im XML-Ereignis „Audit“ ist leer `HandleID` (Beispiel: `<Data Name="HandleID">00000000000000;00;00000000;00000000</Data>` ).
+
...
* Wenn das offene Ereignis eine offene Anfrage zum Öffnen eines vorhandenen Objekts ist, wird dem Audit-Ereignis das zugewiesene Handle dieses Objekts im zugewiesen `HandleID` Tag (zum Beispiel: `<Data Name="HandleID">00000000000401;00;000000ea;00123ed4</Data>` ).
