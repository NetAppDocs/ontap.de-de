...
Erfahren Sie mehr über  `fpolicy persistent-store create` im link:https://docs.netapp.com/us-en/ontap-cli/vserver-fpolicy-persistent-store-create.html["ONTAP-Befehlsreferenz"^] .
