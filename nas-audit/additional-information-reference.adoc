...
* https://www.netapp.com/pdf.html?item=/media/16326-tr-4191.pdf["Technischer Bericht 4191 von NetApp: Best Practices Guide for Clustered Data ONTAP 8.2 Windows File Services"^]
+
