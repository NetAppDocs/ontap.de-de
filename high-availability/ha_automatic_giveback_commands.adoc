...
Für Details zu allen `storage failover modify` Parameter, siehe link:https://docs.netapp.com/us-en/ontap-cli-9131/storage-failover-modify.html["Handbuch für ONTAP-Seiten"].
