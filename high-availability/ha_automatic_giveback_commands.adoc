...
Für Details zu allen `storage failover modify` Parameter, siehe link:https://docs.netapp.com/us-en/ontap-cli/storage-failover-modify.html["Handbuch für ONTAP-Seiten"].
