...
[NOTE]
====
Bevor Sie den Befehl zum Storage-Failover mit der Option „sofort“ ausgeben, müssen Sie die Daten-LIFs mit dem folgenden Befehl auf einen anderen Node migrieren: `network interface migrate-all -node _node_`
