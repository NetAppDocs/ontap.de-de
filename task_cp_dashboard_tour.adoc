...
Ab ONTAP 9.19.1 können SVM-Administratoren ihre eigenen SVMs über ein spezielles SVM-Administrator-Dashboard im ONTAP System Manager überwachen und verwalten. Weitere Informationen finden Sie unter link:task-svm-admin-dashboard-sm.html["Verwalten und überwachen Sie SVMs mit System Manager"].
