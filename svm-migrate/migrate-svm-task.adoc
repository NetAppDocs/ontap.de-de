...
Ab ONTAP 9.19.1 werden Direct-Attachment FC- und FC-NVMe-Konfigurationen für bestimmte AFF, ASA r2 und FAS Systeme unterstützt. Direct-Attachment Konfigurationen unterstützen keine SMV Migration.
