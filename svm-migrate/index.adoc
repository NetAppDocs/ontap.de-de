...
| Manipulationssichere Snapshot Kopie Sperrung | ONTAP 9.14.1 | Die manipulationssichere Sperrung von Snapshot Kopien entspricht nicht SnapLock. SnapLock wird weiterhin nicht unterstützt. 
