...
* Die Quell- und Ziel-Cluster müssen über SnapMirror Synchronous verfügen link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["Lizenz installiert"].
...
| SnapMirror Cloud Beziehungen | ONTAP 9.12.1 | Ab ONTAP 9.12.1 muss bei der Migration einer SVM mit SnapMirror Cloud Beziehungen die SnapMirror Cloud Lizenz auf dem Ziel-Cluster installiert sein. Zudem muss ausreichend Kapazität zur Verfügung stehen, um das Verschieben der Kapazität der zu gespiegelten Volumes in die Cloud zu unterstützen. 
