...
summary: Sie können lokale UNIX-Benutzer und -Gruppen auf der SVM für Authentifizierung und Namenszuordnung verwenden. Sie können UNIX-Benutzer und -Gruppen manuell erstellen oder eine Datei mit UNIX-Benutzern oder -Gruppen von einem Uniform Resource Identifier laden. 
---
