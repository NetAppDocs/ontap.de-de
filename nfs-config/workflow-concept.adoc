...
image::../media/nfs-config-pg-workflow.gif[Zeigt einen Überblick über den NFS-Setup-Prozess,including the steps that occur before NFS setup begins,and the steps that can be optionally performed afterwards.]
