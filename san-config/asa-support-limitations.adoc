...
NOTE: Diese Einschränkungen gelten für ASA-Systeme. Wenn Sie ein ASA r2-System (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 oder ASA C30) besitzen, siehe link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA r2-Systemspeichergrenzen"^].
...
Weitere Informationen zu persistenten Ports sind unter link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Technischer Bericht 4080 zu NetApp: Best Practices für modernes SAN"^] zu finden.
