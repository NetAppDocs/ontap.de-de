...
image::../media/scrn-en-drw-iscsi-dual.png[Konfiguration von HA-Paaren aus mehreren Netzwerken]
...
image::../media/scrn-en-drw-iscsi-single.png[HA-Paar-Konfiguration im Singe-Network]
...
image::../media/dual-host-dual-controller.png[Konfiguration der direkten Anlage]
