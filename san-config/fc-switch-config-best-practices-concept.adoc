...
Best Practices zu FC und iSCSI sind unter  https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["Technischer Bericht 4080 zu NetApp: Best Practices für modernes SAN"^] zu finden.
