...
`-default-site`
 a| 
Optional: Ab ONTAP 9.13.1 wird die Standard-Site verwendet, wenn eine LIF keine Site-Mitgliedschaft hat, und als Fallback, wenn die Site-Ermittlung der vertrauenswürdigen Domäne fehlschlägt.
 a| 
