...
. Klicken Sie im lokalen Cluster (links dargestellt) auf , und wählen Sie *Umschalten der Remote-Datenservices auf image:icon_kabob.gif["Symbol für Menüoptionen"]den lokalen Standort*.
+
...
. Klicken Sie im lokalen Cluster (links dargestellt) auf image:icon_kabob.gif["Symbol für Menüoptionen"], und wählen Sie *Kontrolle zurücknehmen*.
+
...
. Wenn die Datenheilung abgeschlossen ist, klicken Sie auf image:icon_kabob.gif["Symbol für Menüoptionen"], und wählen Sie *Switchback initiieren* aus.
+
