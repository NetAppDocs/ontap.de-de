...
summary: Sie können den NFS-Zugriff auf virtuelle Speichermaschinen über TCP und UDP aktivieren bzw. deaktivieren, indem Sie die Parameter -tcp bzw. -udp anpassen. Dadurch können Sie steuern, ob NFS-Clients in Ihrer Umgebung über TCP oder UDP auf Daten zugreifen können. 
---
