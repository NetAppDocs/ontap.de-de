...
summary: Sie können Informationen zu eingebundenen Volumes für Storage Virtual Machines und die Verbindungspunkte anzeigen, an denen die Volumes eingebunden sind. Sie können auch ermitteln, welche Volumes nicht an einen Verbindungspunkt eingebunden sind. Mithilfe dieser Informationen können Sie Ihren SVM-Namespace verstehen und verwalten. 
---
