...
sidebar: sidebar 
keywords: use, ldap 
summary: Ein LDAP-Server ermöglicht die zentrale Verwaltung von Benutzerinformationen. Wenn Sie Ihre Benutzerdatenbank auf einem LDAP-Server in Ihrer Umgebung speichern, können Sie Ihr Speichersystem so konfigurieren, dass es Benutzerinformationen in Ihrer bestehenden LDAP-Datenbank abruft. 
---
