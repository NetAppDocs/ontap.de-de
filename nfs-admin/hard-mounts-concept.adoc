...
summary: 'Bei der Fehlersuche bei Mount-Problemen müssen Sie sicherstellen, dass Sie den richtigen Mount-Typ verwenden. NFS unterstützt zwei Mount-Typen: Soft-Mounts und Hard-Mounts. Aus Gründen der Zuverlässigkeit sollten Sie ausschließlich Hard-Mounts verwenden.' 
---
