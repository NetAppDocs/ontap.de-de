...
Weitere Informationen zu link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/How_to_prevent_directories_from_being_renamed_while_clients_are_accessing_them["So verhindern Sie, dass Verzeichnisse umbenannt werden, während Clients auf sie zugreifen"^].
