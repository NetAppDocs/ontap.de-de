...
summary: Sie können NFSv4.0 aktivieren oder deaktivieren, indem Sie die Option -v4.0 ändern. Dadurch wird Dateizugriff für Clients ermöglicht, die das NFSv4.0-Protokoll verwenden. In ONTAP 9.9.1 ist NFSv4.0 standardmäßig aktiviert. In früheren Versionen ist es standardmäßig deaktiviert. 
---
