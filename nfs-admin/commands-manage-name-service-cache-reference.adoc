...
summary: 'Sie können den Namensdienstcache verwalten, indem Sie den Wert für die Gültigkeitsdauer (Time-to-Live, TTL) ändern. Der TTL-Wert bestimmt, wie lange Namensdienstinformationen im Cache gespeichert werden.' 
---
