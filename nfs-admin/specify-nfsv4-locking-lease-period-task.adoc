...
summary: Um die Sperrdauer für NFSv4 festzulegen, können Sie die Option -v4-lease-seconds anpassen. Kürzere Sperrdauern beschleunigen die Serverwiederherstellung, während längere Sperrdauern für Server mit einer sehr hohen Anzahl von Clients von Vorteil sind. 
---
