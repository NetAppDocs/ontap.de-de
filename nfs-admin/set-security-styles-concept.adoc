...
summary: Sicherheitsstile können für FlexVol Volumes und qtrees festgelegt werden. Sicherheitsstile können manuell bei der Erstellung festgelegt, automatisch vererbt oder später geändert werden. 
---
