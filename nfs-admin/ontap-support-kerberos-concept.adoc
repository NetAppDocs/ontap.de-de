...
summary: Kerberos bietet eine starke und sichere Authentifizierung für Client/Server-Anwendungen. Die Authentifizierung dient der Überprüfung der Identität von Benutzern und Prozessen gegenüber einem Server. In der ONTAP Umgebung bietet Kerberos Authentifizierung zwischen Storage Virtual Machines und NFS-Clients. 
---
