...
Der `vserver nfs storepool show` Befehl zeigt die Anzahl der belegten Speicherpool-Ressourcen an. Ein StorePool ist ein Pool von Resoures, der von NFSv4-Clients verwendet wird.
