...
summary: Sie können NFSv4.1 aktivieren oder deaktivieren, indem Sie die Option -v4.1 ändern. Dadurch wird Dateizugriff für Clients ermöglicht, die das NFSv4.1-Protokoll verwenden. In ONTAP 9.9.1 ist NFSv4.1 standardmäßig aktiviert. In früheren Versionen ist es standardmäßig deaktiviert. 
---
