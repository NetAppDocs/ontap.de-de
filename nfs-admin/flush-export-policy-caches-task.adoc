...
summary: Durch das manuelle Leeren der Exportrichtlinien-Caches werden möglicherweise veraltete Informationen entfernt und ONTAP dazu gezwungen, aktuelle Informationen aus den entsprechenden externen Ressourcen abzurufen. Dies kann zur Behebung verschiedener Probleme im Zusammenhang mit dem Clientzugriff auf NFS-Exporte beitragen. 
---
