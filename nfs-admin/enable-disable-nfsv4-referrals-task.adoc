...
sidebar: sidebar 
keywords:  
summary: Sie können NFSv4-Verweise auf Storage Virtual Machines aktivieren, indem Sie die Optionen -v4-fsid-change und -v4.0-referrals oder -v4.1-referrals aktivieren. Die Aktivierung von NFSv4-Verweisen kann zu einem schnelleren Datenzugriff für NFSv4-Clients führen, die diese Funktion unterstützen. 
---
