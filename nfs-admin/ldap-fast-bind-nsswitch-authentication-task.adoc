...
summary: Ab ONTAP 9.11.1 können Sie die LDAP-Fast-Bind-Funktionalität für schnellere und einfachere Client-Authentifizierungsanfragen nutzen. Um diese Funktionalität zu verwenden, muss der LDAP-Server die Fast-Bind-Funktionalität unterstützen. 
---
