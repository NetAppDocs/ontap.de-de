...
summary: pNFS verbessert die Leistung, indem es NFS-Clients ermöglicht, lesen/schreiben-Operationen direkt und parallel auf Speichergeräten durchzuführen und so den NFS-Server als potenziellen Engpass zu umgehen. Um pNFS zu aktivieren oder zu deaktivieren, können Sie die Option -v4.1-pnfs anpassen. 
---
