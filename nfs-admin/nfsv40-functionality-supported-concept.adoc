...
EMPFOHLENE VORGEHENSWEISE: NFSv4.1 oder NFSv4.2 sollten anstelle von NFSv4.0 verwendet werden. NFSv4.0 ist eine ältere Version des NFS-Protokolls und wird von der NFS-Community nicht mehr aktiv weiterentwickelt.
