...
|===
Sie können Regeln erstellen, um den folgenden Befehl ab ONTAP 9.13.1 zu schützen:
...
Die Regeln für MAV-System-default-Befehle, die `security multi-admin-verify` link:../multi-admin-verify/index.html#how-multi-admin-verification-works["Befehle"], Kann nicht geändert werden.
