...
Ab ONTAP 9.15.1 können Sie Active Directory (AD)-Benutzer als MAV-Administratoren konfigurieren.  Der AD-Benutzer musslink:../authentication/grant-access-active-directory-users-groups-task.html["als ONTAP -Administrator konfiguriert"] .
