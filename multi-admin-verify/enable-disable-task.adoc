...
TIP: Wenn MAV mit Autonomous Ransomware Protection verwendet wird, sollte eine neue oder bestehende Genehmigungsgruppe definiert werden, die für die Genehmigung von Anfragen zum Pausieren, Deaktivieren und Löschen von verdächtigem Ransomware-Schutz zuständig ist.
