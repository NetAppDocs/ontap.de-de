...
.Über diese Aufgabe
Dieses Verfahren gilt für link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF, ASA FAS"^] Und link:https://docs.netapp.com/us-en/ontap-afx/index.html["AFX-Systeme"^]Die Wenn Sie ein ASA r2-System (ASA A1K, ASA A90, ASA A70, ASA A50, ASA A30, ASA A20 oder ASA C30) besitzen, befolgen Sie die Anweisungen. link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["Diesen Schritten ausführen"^] Um einen ONTAP Cluster mithilfe des System Managers einzurichten. ASA r2-Systeme bieten eine vereinfachte ONTAP Benutzererfahrung speziell für Kunden, die ausschließlich SAN nutzen.
