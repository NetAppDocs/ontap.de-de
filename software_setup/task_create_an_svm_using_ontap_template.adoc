...
.Schritte
. Notieren Sie sich die Werte für die Parameter, die in der Vorlage für die Erstellung und Konfiguration der SVM definiert werden: `template parameter show`
+
[listing]
----
