...
....
Siehe link:https://docs.netapp.com/us-en/ontap-ems-9121/smbc-pfo-events.html["EMS-Referenz"^] Um Informationen zu Ereignismeldungen und Korrekturmaßnahmen zu erhalten.
...
Last Progress Update: -
  ...
  Error Reason codes: -
....
Siehe link:https://docs.netapp.com/us-en/ontap-ems-9121/smbc-aufo-events.html["EMS-Referenz"^] Um Informationen zu Ereignismeldungen und zu Korrekturmaßnahmen zu erhalten.
