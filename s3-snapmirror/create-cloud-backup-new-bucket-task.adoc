...
summary: Wenn Sie neue S3-Buckets erstellen, können sie sofort in einem S3 SnapMirror Ziel-Bucket auf einem Objektspeicher-Provider sichern. Dabei kann es sich um ein StorageGRID System oder eine AWS S3-Implementierung handelt. 
---
...
[role="lead"]
Wenn Sie neue S3-Buckets erstellen, können sie sofort in einem S3 SnapMirror Ziel-Bucket auf einem Objektspeicher-Provider sichern. Dabei kann es sich um ein StorageGRID System oder eine AWS S3-Implementierung handelt.
