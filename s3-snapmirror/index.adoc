...
** S3 SnapMirror als Ziel für andere NetApp Objektspeicher-Ziele (ONTAP S3, StorageGRID und Cloud Volumes ONTAP)
** S3 SnapMirror für Objektspeicher von Drittanbietern, einschließlich AWS S3 (verfügbar im link:../data-protection/install-snapmirror-cloud-license-task.html["ONTAP One Kompatibilitätspaket"])
