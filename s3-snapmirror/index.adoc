...
(Ab ONTAP 9.9) | image:status-enabled-perf-config.gif["Häkchen"] | image:status-enabled-perf-config.gif["Häkchen"] 


| Cloud Volumes ONTAP für AWS
(Ab ONTAP 9.11.0) | image:status-enabled-perf-config.gif["Häkchen"] | image:status-enabled-perf-config.gif["Häkchen"] 


| Cloud Volumes ONTAP für Google Cloud
(Ab ONTAP 9.12.0) | image:status-enabled-perf-config.gif["Häkchen"] | image:status-enabled-perf-config.gif["Häkchen"] 
|===
