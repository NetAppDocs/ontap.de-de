...
NOTE: Für den Zugriff auf Cache-Volumes mit dem NFSv4.x-Protokoll müssen sowohl der Ursprungs- als auch der Cache-Cluster ONTAP 9.10.1 oder höher verwenden. Der ursprüngliche und der FlexCache-Cluster können über unterschiedliche ONTAP-Versionen verfügen, aber beide sollten ONTAP 9.10.1 und höhere Versionen sein, beispielsweise kann der Ursprung über ONTAP 9.10.1 verfügen, und der Cache sollte ONTAP 9.11.1 haben.
