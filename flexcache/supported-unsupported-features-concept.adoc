...
Unterstützt ab ONTAP 9.5.  Der primäre SVM einer SVM-DR-Beziehung kann das Ursprungsvolume haben; wenn die SVM-DR-Beziehung jedoch unterbrochen wird, muss die FlexCache Beziehung mit einem neuen Ursprungsvolume neu erstellt werden.
 a| 
Nein
