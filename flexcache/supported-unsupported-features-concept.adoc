...
Ab ONTAP 9.10.1 werden die Ursprungs-Volumes von FlexVol unterstützt, die ab ONTAP 9.13.1 für FlexGroup Ursprungs-Volumes unterstützt werden. Siehe link:../anti-ransomware/use-cases-restrictions-concept.html#unsupported-configurations["Anwendungsfälle und Überlegungen zum autonomen Ransomware-Schutz"].
 a| 
Nein
