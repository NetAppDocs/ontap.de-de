...
NOTE: Eine ausführlichere Dokumentation zur FlexCache-Dualität finden Sie unter link:../s3-multiprotocol/index.html#how-s3-multiprotocol-support-works["ONTAP S3 Multiprotokollunterstützung"^].
...
Es gibt viele S3-Clients. Ein guter Ausgangspunkt ist die AWS CLI. Weitere Informationen finden sich unter link:https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html["Installation der AWS CLI"^].
