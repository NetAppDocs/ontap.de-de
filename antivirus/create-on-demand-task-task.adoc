...
+
Eine vollständige Liste der Optionen finden Sie im link:https://docs.netapp.com/us-en/ontap-cli-9141/vserver-vscan-on-demand-task-create.html["Befehlsreferenz"^].
