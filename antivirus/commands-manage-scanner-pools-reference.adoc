...
summary: Sie können Scannerpools ändern und löschen und privilegierte Benutzer und Vscan-Server für einen Scannerpool verwalten. Sie können die Zusammenfassung und Details eines Scannerpools anzeigen. 
---
...
[role="lead"]
Sie können Scannerpools ändern und löschen und privilegierte Benutzer und Vscan-Server für einen Scannerpool verwalten. Sie können die Zusammenfassung und Details eines Scannerpools anzeigen.
