...
. https://review.docs.netapp.com/us-en/ontap_pcarriga-ontapdoc1416-9oct/system-admin/add-nodes-cluster-concept.html["Fügen Sie die neuen Nodes dem Cluster hinzu"].
