...
Diese Richtlinien dienen zum Upgrade von ONTAP und ONTAP Select vor Ort.  Informationen zum Upgrade von ONTAP in der Cloud finden Sie unter https://docs.netapp.com/us-en/occm/task_updating_ontap_cloud.html["Upgrades der Cloud Volumes ONTAP Software"^].
...
Diese Upgrade-Pfade gelten für On-Premises-ONTAP und ONTAP Select.
...
* Achtung MetroCluster IP Konfigurationen Upgrade von ONTAP 9.8*:
