...
+
Beispielsweise können Sie den direkten Upgrade-Pfad von 9.12.1 auf 9.13.1 oder von 9.13.1 auf 9.17.1 nutzen.
...
+
Wenn Sie beispielsweise derzeit Version 9.8 verwenden und auf Version 9.16.1 aktualisieren möchten, müssen Sie ein mehrstufiges Upgrade durchführen: zuerst von 9.8 auf 9.12.1 und dann von 9.12.1 auf 9.16.1.  Für ein Upgrade von früheren Versionen sind möglicherweise drei oder mehr Stufen mit mehreren Zwischenaktualisierungen erforderlich.
...
[cols="25,25,50"]
|===
| Wenn Ihre aktuelle ONTAP Release... | Die ONTAP Zielversion lautet… | Ihr automatisierter oder manueller Upgrade-Pfad beträgt… 
...
[cols="25,25,50"]
|===
| Wenn Ihre aktuelle ONTAP Release... | Die ONTAP Zielversion lautet… | Ihr automatisierter Upgrade-Pfad lautet… 
...
[cols="25,25,50"]
|===
| Wenn Ihre aktuelle ONTAP Release... | Die ONTAP Zielversion lautet… | Ihr manueller Upgrade-Pfad lautet… 
