...
Wenn Sie eine Zwei-Knoten-MetroCluster-Konfiguration mit ONTAP 9.3 oder höher verwenden, befolgen Sie die CLI-Schritte in link:automated-upgrade-task.html["Installation des ONTAP Images mit automatischem unterbrechungsfreien ONTAP Upgrade"].
