...
| Nutze ich S3 SnapMirror und führe ich ein Upgrade auf ONTAP 9.12.1 oder höher aus? | link:considerations-for-s3-snapmirror-concept.html["Überlegungen zu S3 SnapMirror Konfigurationen"] 
