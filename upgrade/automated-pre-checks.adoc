...
Um die automatischen Upgrade-Vorabprüfungen für einen auszuführenlink:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html#types-of-upgrade-paths["Direktes Multi-Hop-Upgrade"], müssen Sie nur das Softwarepaket für Ihre ONTAP-Zielversion herunterladen. Sie müssen die mittlere ONTAP-Version nicht laden, bis Sie mit dem eigentlichen Upgrade beginnen. Wenn Sie z. B. automatisierte Prüfungen vor dem Upgrade für ein Upgrade von 9.8 auf 9.13.1 ausführen, müssen Sie das Softwarepaket für ONTAP 9.13.1 herunterladen. Sie müssen das Softwarepaket für ONTAP 9.12.1 nicht herunterladen.
