...
NOTE: Wenn Sie über NetApp auf ONTAP 9.15.1 oder höher aktualisieren, folgen Sie denlink:https://docs.netapp.com/us-en/console-software-updates/get-started/software-updates.html["Upgrade-Verfahren in der NetApp -Konsolendokumentation"^] .
...
+
<<<<<<< HEAD Für anonymes FTP müssen Sie die URL im Format +ftp://anonymous@ftpserver+ angeben.



[]
=====
Für anonymes FTP müssen Sie die URL im Format \ftp://anonymous@ftpserver angeben. >>>>>>> 20a8478e44f7b38038f6e148d4bfb0026800d5ff
...
+
Es wird eine Liste aller automatisierten Vorabprüfungen für das Upgrade angezeigt, zusammen mit allen Fehlern und Warnungen, die vor Beginn des Upgrade-Prozesses behoben werden sollten. Sie müssen alle Fehler beheben, bevor Sie mit dem Upgrade fortfahren. Es empfiehlt sich, auch Warnungen zu beheben.
