...
summary: Wenn ein automatisiertes ONTAP-Softwareupgrade aufgrund eines Fehlers angehalten wird, sollten Sie den Fehler beheben und dann mit dem Upgrade fortfahren. 
---
