...
---
= Stellen Sie vor dem Upgrade sicher, dass alle LIFS sich auf Home-Ports befinden
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Während eines Neubootens wurden möglicherweise einige LIFs zu ihren zugewiesenen Failover-Ports migriert. Vor und nach dem Upgrade eines Clusters müssen Sie alle LIFs, die sich nicht auf den Home-Ports befinden, aktivieren und zurücksetzen.
